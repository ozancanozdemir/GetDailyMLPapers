...
![Update Status](https://img.shields.io/badge/Daily%20Updates-Active-success?style=flat-square)
![License](https://img.shields.io/badge/Source-ArXiv-red?style=flat-square)

---

## 🎯 Tracked Categories

This repository automatically fetches the latest papers from **ArXiv** every day, focusing on the intersection of Artificial Intelligence and Quantitative Finance.

| Badge | Code | Description |
| :--- | :--- | :--- |
| ![AI](https://img.shields.io/badge/cs.AI-Artificial%20Intelligence-ff69b4?style=flat-square) | `cs.AI` | Artificial Intelligence |
| ![CV](https://img.shields.io/badge/cs.CV-Computer%20Vision-blueviolet?style=flat-square) | `cs.CV` | Computer Vision & Pattern Recognition |
| ![ML](https://img.shields.io/badge/cs.LG-Machine%20Learning-blue?style=flat-square) | `cs.LG` | Machine Learning (CS) |
| ![NLP](https://img.shields.io/badge/cs.CL-NLP-yellowgreen?style=flat-square) | `cs.CL` | Computation and Language |
| ![Stat](https://img.shields.io/badge/stat.ML-Statistics-orange?style=flat-square) | `stat.ML` | Machine Learning (Statistics) |
| ![Fin](https://img.shields.io/badge/q--fin.CP-Comp.%20Finance-00c853?style=flat-square) | `q-fin.CP` | Computational Finance |
...
- **MemFlow: Flowing Adaptive Memory for Consistent and Efficient Long Video Narratives**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14699v1)

- **TimeLens: Rethinking Video Temporal Grounding with Multimodal LLMs**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.AI, cs.CL, cs.MM`
  - [Read Paper](https://arxiv.org/abs/2512.14698v1)

- **Spherical Leech Quantization for Visual Tokenization and Generation**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.14697v1)

- **CRISP: Contact-Guided Real2Sim from Monocular Video with Planar Scene Primitives**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.GR, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.14696v1)

- **Universal Reasoning Model**
  - 📅 2025-12-16 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14693v1)

- **Native and Compact Structured Latents for 3D Generation**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14692v1)

- **MMGR: Multi-Modal Generative Reasoning**
  - 📅 2025-12-16 | 🏷️ `cs.CL, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14691v1)

- **CHIP: Adaptive Compliance for Humanoid Control through Hindsight Perturbation**
  - 📅 2025-12-16 | 🏷️ `cs.RO, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.14689v1)

- **Spoken DialogSum: An Emotion-Rich Conversational Dataset for Spoken Dialogue Summarization**
  - 📅 2025-12-16 | 🏷️ `cs.CL, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.14687v1)

- **Bias-Variance Trade-off for Clipped Stochastic First-Order Methods: From Bounded Variance to Infinite Mean**
  - 📅 2025-12-16 | 🏷️ `cs.LG, cs.AI, stat.CO, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.14686v1)
...
- **Fast and Accurate Causal Parallel Decoding using Jacobi Forcing**
  - 📅 2025-12-16 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.14681v1)

- **VASA-3D: Lifelike Audio-Driven Gaussian Head Avatars from a Single Image**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14677v1)

- **Beyond Lipschitz Continuity and Monotonicity: Fractal and Chaotic Activation Functions in Echo State Networks**
  - 📅 2025-12-16 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.14675v1)

- **ART: Articulated Reconstruction Transformer**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14671v1)

- **EVOLVE-VLA: Test-Time Training from Environment Feedback for Vision-Language-Action Models**
  - 📅 2025-12-16 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14666v1)

- **Enhancing Visual Sentiment Analysis via Semiotic Isotopy-Guided Dataset Construction**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14665v1)

- **gridfm-datakit-v1: A Python Library for Scalable and Realistic Power Flow and Optimal Power Flow Data Generation**
  - 📅 2025-12-16 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14658v1)

- **WaveSim: A Wavelet-based Multi-scale Similarity Metric for Weather and Climate Fields**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14656v1)

- **ViRC: Enhancing Visual Interleaved Mathematical CoT with Reason Chunking**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14654v1)

- **Segmental Attention Decoding With Long Form Acoustic Encodings**
  - 📅 2025-12-16 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.14652v1)

- **Adaptable Segmentation Pipeline for Diverse Brain Tumors with Radiomic-guided Subtyping and Lesion-Wise Model Ensemble**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14648v1)

- **TiME: Tiny Monolingual Encoders for Efficient NLP Pipelines**
  - 📅 2025-12-16 | 🏷️ `cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.14645v1)

- **A Multicenter Benchmark of Multiple Instance Learning Models for Lymphoma Subtyping from HE-stained Whole Slide Images**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14640v1)
...
- **AMD-HookNet++: Evolution of AMD-HookNet with Hybrid CNN-Transformer Feature Enhancement for Glacier Calving Front Segmentation**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14639v1)

- **MuseCPBench: an Empirical Study of Music Editing Methods through Music Context Preservation**
  - 📅 2025-12-16 | 🏷️ `cs.SD, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14629v1)

- **Learning the score under shape constraints**
  - 📅 2025-12-16 | 🏷️ `stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.14624v1)

- **Distill Video Datasets into Images**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14621v1)

- **JMMMU-Pro: Image-based Japanese Multi-discipline Multimodal Understanding Benchmark via Vibe Benchmark Construction**
  - 📅 2025-12-16 | 🏷️ `cs.CL, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14620v1)

- **ParaFormer: A Generalized PageRank Graph Transformer for Graph Representation Learning**
  - 📅 2025-12-16 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.14619v1)

- **Model-Based Reinforcement Learning in Discrete-Action Non-Markovian Reward Decision Processes**
  - 📅 2025-12-16 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14617v1)

- **Hierarchical Persistence Velocity for Network Anomaly Detection: Theory and Applications to Cryptocurrency Markets**
  - 📅 2025-12-16 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.14615v1)

- **WorldPlay: Towards Long-Term Geometric Consistency for Real-Time Interactive World Modeling**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.GR`
  - [Read Paper](https://arxiv.org/abs/2512.14614v1)

- **LLmFPCA-detect: LLM-powered Multivariate Functional PCA for Anomaly Detection in Sparse Longitudinal Texts**
  - 📅 2025-12-16 | 🏷️ `stat.ML, cs.LG`
...
- **Efficient-DLM: From Autoregressive to Diffusion Language Models, and Beyond in Speed**
  - 📅 2025-12-16 | 🏷️ `cs.CL, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.14067v1)

- **What Affects the Effective Depth of Large Language Models?**
  - 📅 2025-12-16 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.14064v1)

- **Bridging Fidelity-Reality with Controllable One-Step Diffusion for Image Super-Resolution**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14061v1)
...
- **Real-time prediction of workplane illuminance distribution for daylight-linked controls using non-intrusive multimodal deep learning**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14058v1)

- **FacEDiT: Unified Talking Face Editing and Generation via Facial Motion Infilling**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14056v1)

- **Expert Switching for Robust AAV Landing: A Dual-Detector Framework in Simulation**
  - 📅 2025-12-16 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14054v1)

- **HyperVL: An Efficient and Dynamic Multimodal Large Language Model for Edge Devices**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.14052v1)

- **OpenDataArena: A Fair and Open Arena for Benchmarking Post-Training Dataset Value**
  - 📅 2025-12-16 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14051v1)

- **SELECT: Detecting Label Errors in Real-world Scene Text Data**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14050v1)

- **Intention Chain-of-Thought Prompting with Dynamic Routing for Code Generation**
  - 📅 2025-12-16 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14048v1)

- **A Deep Dive into Function Inlining and its Security Implications for ML-based Binary Analysis**
  - 📅 2025-12-16 | 🏷️ `cs.CR, cs.LG, cs.PL`
  - [Read Paper](https://arxiv.org/abs/2512.14045v1)

- **OmniDrive-R1: Reinforcement-driven Interleaved Multi-modal Chain-of-Thought for Trustworthy Vision-Language Autonomous Driving**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14044v1)

- **Evaluating Small Language Models for Agentic On-Farm Decision Support Systems**
  - 📅 2025-12-16 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14043v1)

- **ChartAgent: A Chart Understanding Framework with Tool Integrated Reasoning**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.14040v1)

- **ASAP-Textured Gaussians: Enhancing Textured Gaussians with Adaptive Sampling and Anisotropic Parameterization**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.14039v1)

- **ACE-SLAM: Scene Coordinate Regression for Neural Implicit Real-Time SLAM**
  - 📅 2025-12-16 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.14032v1)
...
- **Evaluating Frontier LLMs on PhD-Level Mathematical Reasoning: A Benchmark on a Textbook in Theoretical Computer Science about Randomized Algorithms**
  - 📅 2025-12-16 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13978v1)
...
- **XAI-Driven Diagnosis of Generalization Failure in State-Space Cerebrovascular Segmentation Models: A Case Study on Domain Shift Between RSNA and TopCoW Datasets**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13977v1)

- **Quality-Driven and Diversity-Aware Sample Expansion for Robust Marine Obstacle Segmentation**
  - 📅 2025-12-16 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13970v1)

- **Olmo 3**
  - 📅 2025-12-15 | 🏷️ `cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13961v1)
...
- **EvoLattice: Persistent Internal-Population Evolution through Multi-Alternative Quality-Diversity Graph Representations for LLM-Guided Program Discovery**
  - 📅 2025-12-15 | 🏷️ `cs.AI, cs.CL, cs.LG, cs.MA, cs.NE`
  - [Read Paper](https://arxiv.org/abs/2512.13857v1)

- **Improvise, Adapt, Overcome -- Telescopic Adapters for Efficient Fine-tuning of Vision Language Models in Medical Imaging**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13855v1)

- **Dropout Neural Network Training Viewed from a Percolation Perspective**
  - 📅 2025-12-15 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.13853v1)

- **Topologically-Stabilized Graph Neural Networks: Empirical Robustness Across Domains**
  - 📅 2025-12-15 | 🏷️ `cs.LG, cs.SI`
  - [Read Paper](https://arxiv.org/abs/2512.13852v1)

- **BiCoRec: Bias-Mitigated Context-Aware Sequential Recommendation Model**
  - 📅 2025-12-15 | 🏷️ `cs.IR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13848v1)

- **MoLingo: Motion-Language Alignment for Text-to-Motion Generation**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13840v1)

- **Explainable reinforcement learning from human feedback to improve alignment**
  - 📅 2025-12-15 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13837v1)

- **VajraV1 -- The most accurate Real Time Object Detector of the YOLO family**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13834v1)

- **Unreasonable effectiveness of unsupervised learning in identifying Majorana topology**
  - 📅 2025-12-15 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13825v1)

- **The Double Life of Code World Models: Provably Unmasking Malicious Behavior Through Execution Traces**
  - 📅 2025-12-15 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13821v1)

- **EEG-D3: A Solution to the Hidden Overfitting Problem of Deep Learning Models**
  - 📅 2025-12-15 | 🏷️ `cs.LG, cs.AI, cs.CV, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.13806v1)

- **Nexels: Neurally-Textured Surfels for Real-Time Novel View Synthesis with Sparse Geometries**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13796v1)

- **Constrained Policy Optimization via Sampling-Based Weight-Space Projection**
  - 📅 2025-12-15 | 🏷️ `cs.LG, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.13788v1)

- **Quantum oracles give an advantage for identifying classical counterfactuals**
  - 📅 2025-12-15 | 🏷️ `stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.13692v1)

- **DiffusionBrowser: Interactive Diffusion Previews via Multi-Branch Decoders**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.AI, cs.GR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13690v1)

- **LitePT: Lighter Yet Stronger Point Transformer**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13689v1)

- **Towards Scalable Pre-training of Visual Tokenizers for Generation**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13687v1)
...
- **Recurrent Video Masked Autoencoders**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13684v1)

- **I-Scene: 3D Instance Models are Implicit Generalizable Spatial Learners**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13683v1)

- **LASER: Layer-wise Scale Alignment for Training-Free Streaming 4D Reconstruction**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13680v1)

- **Feedforward 3D Editing via Text-Steerable Image-to-3D**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13678v1)

- **JoVA: Unified Multimodal Learning for Joint Video-Audio Generation**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13677v1)

- **Towards Effective Model Editing for LLM Personalization**
  - 📅 2025-12-15 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.13676v1)

- **Towards Interactive Intelligence for Digital Humans**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.CL, cs.GR, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.13674v1)

- **Directional Textual Inversion for Personalized Text-to-Image Generation**
  - 📅 2025-12-15 | 🏷️ `cs.LG, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13672v1)

- **AgentIAD: Tool-Augmented Single-Agent for Industrial Anomaly Detection**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13671v1)

- **A Scientific Reasoning Model for Organic Synthesis Procedure Generation**
  - 📅 2025-12-15 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13668v1)

- **A stylometric analysis of speaker attribution from speech transcripts**
  - 📅 2025-12-15 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.13667v2)

- **SEDULity: A Proof-of-Learning Framework for Distributed and Secure Blockchains with Efficient Useful Work**
  - 📅 2025-12-15 | 🏷️ `cs.CR, cs.DC, cs.IT, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13666v1)

- **Grab-3D: Detecting AI-Generated Videos from 3D Geometric Temporal Consistency**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13665v1)

- **RoboTracer: Mastering Spatial Trace with Reasoning in Vision-Language Models for Robotics**
  - 📅 2025-12-15 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13660v1)
...
- **Embedding-Based Rankings of Educational Resources based on Learning Outcome Alignment: Benchmarking, Expert Validation, and Learner Performance**
  - 📅 2025-12-15 | 🏷️ `cs.CY, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13658v1)
...
- **Machine learning to optimize precision in the analysis of randomized trials: A journey in pre-specified, yet data-adaptive learning**
  - 📅 2025-12-15 | 🏷️ `stat.ME, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.13610v1)

- **Do-Undo: Generating and Reversing Physical Actions in Vision-Language Models**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13609v1)

- **DBT-DINO: Towards Foundation model based analysis of Digital Breast Tomosynthesis**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13608v1)

- **Nemotron-Cascade: Scaling Cascaded Reinforcement Learning for General-Purpose Reasoning Models**
  - 📅 2025-12-15 | 🏷️ `cs.CL, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13607v1)

- **LongVie 2: Multimodal Controllable Ultra-Long Video World Model**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13604v1)

- **DA-SSL: self-supervised domain adaptor to leverage foundational models in turbt histopathology slides**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13600v1)

- **Textual Gradients are a Flawed Metaphor for Automatic Prompt Optimization**
  - 📅 2025-12-15 | 🏷️ `cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13598v1)

- **Lighting in Motion: Spatiotemporal HDR Lighting Estimation**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13597v1)

- **Scalable Formal Verification via Autoencoder Latent Space Abstraction**
  - 📅 2025-12-15 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13593v2)

- **Image Diffusion Preview with Consistency Solver**
  - 📅 2025-12-15 | 🏷️ `cs.LG, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13592v1)

- **ReFusion: A Diffusion Large Language Model with Parallel Autoregressive Decoding**
  - 📅 2025-12-15 | 🏷️ `cs.CL, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13586v1)

- **DP-CSGP: Differentially Private Stochastic Gradient Push with Compressed Communication**
  - 📅 2025-12-15 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13583v1)

- **MMhops-R1: Multimodal Multi-hop Reasoning**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13573v2)

- **Superposition as Lossy Compression: Measure with Sparse Autoencoders and Connect to Adversarial Vulnerability**
  - 📅 2025-12-15 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13568v1)

- **A Nonparametric Statistics Approach to Feature Selection in Deep Neural Networks with Theoretical Guarantees**
  - 📅 2025-12-15 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13565v1)

- **Memory in the Age of AI Agents**
  - 📅 2025-12-15 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13564v1)

- **3D Human-Human Interaction Anomaly Detection**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13560v1)

- **Verifying Rumors via Stance-Aware Structural Modeling**
  - 📅 2025-12-15 | 🏷️ `cs.CL, cs.AI, cs.CY`
  - [Read Paper](https://arxiv.org/abs/2512.13559v1)

- **PrahokBART: A Pre-trained Sequence-to-Sequence Model for Khmer Natural Language Generation**
  - 📅 2025-12-15 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.13552v1)

- **A Class of Accelerated Fixed-Point-Based Methods with Delayed Inexact Oracles and Its Applications**
  - 📅 2025-12-15 | 🏷️ `stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.13547v1)

- **Pancakes: Consistent Multi-Protocol Image Segmentation Across Biomedical Domains**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13534v1)
...
- **Uncovering the Role of Initial Saliency in U-Shaped Attention Bias: Scaling Initial Token Weight for Enhanced Long-Text Processing**
  - 📅 2025-12-15 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13109v1)

- **Diffusion-Based Restoration for Multi-Modal 3D Object Detection in Adverse Weather**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13107v1)

- **TraPO: A Semi-Supervised Reinforcement Learning Framework for Boosting LLM Reasoning**
  - 📅 2025-12-15 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13106v1)

- **FID-Net: A Feature-Enhanced Deep Learning Network for Forest Infestation Detection**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13104v1)

- **Socratic Students: Teaching Language Models to Learn by Asking Questions**
  - 📅 2025-12-15 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13102v1)
...
- **Comprehensive Evaluation of Rule-Based, Machine Learning, and Deep Learning in Human Estimation Using Radio Wave Sensing: Accuracy, Spatial Generalization, and Output Granularity Trade-offs**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13031v1)

- **Motus: A Unified Latent Action World Model**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.LG, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.13030v1)

- **SneakPeek: Future-Guided Instructional Streaming Video Generation**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13019v1)
...
- **Comprehensive Deployment-Oriented Assessment for Cross-Environment Generalization in Deep Learning-Based mmWave Radar Sensing**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13018v1)

- **What Happens Next? Next Scene Prediction with a Unified Video Model**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13015v1)

- **JoDiffusion: Jointly Diffusing Image with Pixel-Level Annotations for Semantic Segmentation Promotion**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13014v1)

- **Deep Learning-Driven Inversion Framework for Shear Modulus Estimation in Magnetic Resonance Elastography (DIME)**
  - 📅 2025-12-15 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13010v1)
...
- **TWLR: Text-Guided Weakly-Supervised Lesion Localization and Severity Regression for Explainable Diabetic Retinopathy Grading**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13008v1)

- **Light Field Based 6DoF Tracking of Previously Unobserved Objects**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13007v1)

- **Few-Step Distillation for Text-to-Image Generation: A Practical Guide**
  - 📅 2025-12-15 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.13006v1)

- **General OOD Detection via Model-aware and Subspace-aware Variable Priority**
  - 📅 2025-12-15 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.13003v1)

- **MIDUS: Memory-Infused Depth Up-Scaling**
  - 📅 2025-12-15 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13751v1)

- **Calibrating Uncertainty for Zero-Shot Adversarial CLIP**
  - 📅 2025-12-15 | 🏷️ `cs.CV, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.12997v1)
...
- **A Spatio-Temporal Hybrid Quantum-Classical Graph Convolutional Neural Network Approach for Urban Taxi Destination Prediction**
  - 📅 2025-12-15 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13745v1)
...
- **Network Level Evaluation of Hangup Susceptibility of HRGCs using Deep Learning and Sensing Techniques: A Goal Towards Safer Future**
  - 📅 2025-12-14 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12832v1)

- **GradID: Adversarial Detection via Intrinsic Dimensionality of Gradients**
  - 📅 2025-12-14 | 🏷️ `cs.LG, cs.CR, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.12827v1)

- **Adapting Multimodal Foundation Models for Few-Shot Learning: A Comprehensive Study on Contrastive Captioners**
  - 📅 2025-12-14 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12824v1)

- **Lemon: A Unified and Scalable 3D Multimodal Model for Universal Spatial Understanding**
  - 📅 2025-12-14 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12822v1)

- **On the continuity of flows**
  - 📅 2025-12-14 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12821v1)

- **Hindsight is 20/20: Building Agent Memory that Retains, Recalls, and Reflects**
  - 📅 2025-12-14 | 🏷️ `cs.CL, cs.AI, cs.IR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.12818v1)
...
- **Transport Reversible Jump Markov Chain Monte Carlo with proposals generated by Variational Inference with Normalizing Flows**
  - 📅 2025-12-14 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.12742v1)
...
- **Multi-Trajectory Physics-Informed Neural Networks for HJB Equations with Hard-Zero Terminal Inventory: Optimal Execution on Synthetic & SPY Data**
  - 📅 2025-12-14 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.12708v1)

- **Synergizing Code Coverage and Gameplay Intent: Coverage-Aware Game Playtesting with LLM-Guided Reinforcement Learning**
  - 📅 2025-12-14 | 🏷️ `cs.AI, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.12706v1)

- **Robust Motion Generation using Part-level Reliable Data from Videos**
  - 📅 2025-12-14 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12703v1)

- **Efficient Vision-Language Reasoning via Adaptive Token Pruning**
  - 📅 2025-12-14 | 🏷️ `cs.CV, cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.12701v1)

- **Hybrid Retrieval-Augmented Generation for Robust Multilingual Document Question Answering**
  - 📅 2025-12-14 | 🏷️ `cs.DL, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.12694v1)

- **Co-Exploration and Co-Exploitation via Shared Structure in Multi-Task Bandits**
  - 📅 2025-12-14 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12693v1)

- **WebOperator: Action-Aware Tree Search for Autonomous Agents in Web Environment**
  - 📅 2025-12-14 | 🏷️ `cs.AI, cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.12692v1)

- **Reassessing the Role of Supervised Fine-Tuning: An Empirical Study in VLM Reasoning**
  - 📅 2025-12-14 | 🏷️ `cs.LG, cs.CL, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.12690v1)

- **Theoretical Foundations of Prompt Engineering: From Heuristics to Expressivity**
  - 📅 2025-12-14 | 🏷️ `cs.LG, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.12688v1)

- **Memoria: A Scalable Agentic Memory Framework for Personalized Conversational AI**
  - 📅 2025-12-14 | 🏷️ `cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.12686v1)

- **Quantum Implicit Neural Representations for 3D Scene Reconstruction and Novel View Synthesis**
  - 📅 2025-12-14 | 🏷️ `cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.12683v1)

- **$β$-CLIP: Text-Conditioned Contrastive Learning for Multi-Granular Vision-Language Alignment**
  - 📅 2025-12-14 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.12678v1)

- **Fine-Tuning Causal LLMs for Text Classification: Embedding-Based vs. Instruction-Based Approaches**
  - 📅 2025-12-14 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12677v1)

- **Robust Variational Bayes by Min-Max Median Aggregation**
  - 📅 2025-12-14 | 🏷️ `stat.ME, cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.12676v1)

- **Scone: Bridging Composition and Distinction in Subject-Driven Image Generation via Unified Understanding-Generation Modeling**
  - 📅 2025-12-14 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12675v1)

- **Progressive Conditioned Scale-Shift Recalibration of Self-Attention for Online Test-time Adaptation**
  - 📅 2025-12-14 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.12673v1)

- **On Approaches to Building Surrogate ODE Models for Diffusion Bridges**
  - 📅 2025-12-14 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.12671v1)

- **DynaGen: Unifying Temporal Knowledge Graph Reasoning with Dynamic Subgraphs and Generative Regularization**
  - 📅 2025-12-14 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12669v1)

- **Instilling Organisational Values in Firefighters through Simulation-Based Training**
  - 📅 2025-12-14 | 🏷️ `cs.CY, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13737v1)

- **Open-World Deepfake Attribution via Confidence-Aware Asymmetric Learning**
  - 📅 2025-12-14 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.12667v1)

- **InteracTalker: Prompt-Based Human-Object Interaction with Co-Speech Gesture Generation**
  - 📅 2025-12-14 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.12664v1)

- **PerNodeDrop: A Method Balancing Specialized Subnets and Regularization in Deep Neural Networks**
  - 📅 2025-12-14 | 🏷️ `cs.LG, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.12663v1)
...
- **Anatomy-Guided Representation Learning Using a Transformer-Based Network for Thyroid Nodule Segmentation in Ultrasound Images**
  - 📅 2025-12-14 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12662v1)

- **CogDoc: Towards Unified thinking in Documents**
  - 📅 2025-12-14 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.12658v1)

- **Cross-modal Fundus Image Registration under Large FoV Disparity**
  - 📅 2025-12-14 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.12657v1)

- **Modeling Authorial Style in Urdu Novels Using Character Interaction Graphs and Graph Neural Networks**
  - 📅 2025-12-14 | 🏷️ `cs.CL, cs.LG, cs.SI`
  - [Read Paper](https://arxiv.org/abs/2512.12654v1)

- **Value-Aware Multiagent Systems**
  - 📅 2025-12-14 | 🏷️ `cs.AI, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.12652v1)

- **LexRel: Benchmarking Legal Relation Extraction for Chinese Civil Cases**
  - 📅 2025-12-14 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.12643v1)

- **Torch Geometric Pool: the Pytorch library for pooling in Graph Neural Networks**
  - 📅 2025-12-14 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.12642v1)

- **Which Pieces Does Unigram Tokenization Really Need?**
  - 📅 2025-12-14 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.12641v1)

- **Modular and Multi-Path-Aware Offline Benchmarking for Mobile GUI Agents**
  - 📅 2025-12-14 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12634v1)

- **DiG: Differential Grounding for Enhancing Fine-Grained Perception in Multimodal Large Language Model**
  - 📅 2025-12-14 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12633v1)

- **ORIBA: Exploring LLM-Driven Role-Play Chatbot as a Creativity Support Tool for Original Character Artists**
  - 📅 2025-12-14 | 🏷️ `cs.HC, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12630v1)

- **CoLSE: A Lightweight and Robust Hybrid Learned Model for Single-Table Cardinality Estimation using Joint CDF**
  - 📅 2025-12-14 | 🏷️ `cs.DB, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.12624v1)

- **Reasoning Within the Mind: Dynamic Multimodal Interleaving in Latent Space**
  - 📅 2025-12-14 | 🏷️ `cs.CV, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.12623v1)

- **D3D-VLP: Dynamic 3D Vision-Language-Planning Model for Embodied Grounding and Navigation**
  - 📅 2025-12-14 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.12622v1)

- **Understanding Syllogistic Reasoning in LLMs from Formal and Natural Language Perspectives**
  - 📅 2025-12-14 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.12620v1)
...
- **Exploring the Modular Integration of "AI + Architecture" Pedagogy in Undergraduate Design Education: A Case Study of Architectural Design III/IV Courses at Zhejiang University**
  - 📅 2025-12-14 | 🏷️ `cs.CY, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.13730v1)
...
- **Generative Parametric Design (GPD): A framework for real-time geometry generation and on-the-fly multiparametric approximation**
  - 📅 2025-12-12 | 🏷️ `cs.CE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11748v1)

- **mViSE: A Visual Search Engine for Analyzing Multiplex IHC Brain Tissue Images**
  - 📅 2025-12-12 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11745v1)
...
- **CogniSNN: Enabling Neuron-Expandability, Pathway-Reusability, and Dynamic-Configurability with Random Graph Architectures in Spiking Neural Networks**
  - 📅 2025-12-12 | 🏷️ `cs.NE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11743v1)

- **ECCO: Leveraging Cross-Camera Correlations for Efficient Live Video Continuous Learning**
  - 📅 2025-12-12 | 🏷️ `cs.DC, cs.LG, cs.NI`
  - [Read Paper](https://arxiv.org/abs/2512.11727v1)

- **From Signal to Turn: Interactional Friction in Modular Speech-to-Speech Pipelines**
  - 📅 2025-12-12 | 🏷️ `cs.HC, cs.AI, cs.CL, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.11724v1)
...
- **A Multi-Criteria Automated MLOps Pipeline for Cost-Effective Cloud-Based Classifier Retraining in Response to Data Distribution Shifts**
  - 📅 2025-12-12 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11541v1)

- **HFS: Holistic Query-Aware Frame Selection for Efficient Video Reasoning**
  - 📅 2025-12-12 | 🏷️ `cs.CV, cs.CL, cs.MM`
  - [Read Paper](https://arxiv.org/abs/2512.11534v1)

- **Parallax: Runtime Parallelization for Operator Fallbacks in Heterogeneous Edge Systems**
  - 📅 2025-12-12 | 🏷️ `cs.DC, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11532v1)

- **Parametric Numerical Integration with (Differential) Machine Learning**
  - 📅 2025-12-12 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11530v1)

- **xGR: Efficient Generative Recommendation Serving at Scale**
  - 📅 2025-12-12 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11529v1)

- **Contrastive Time Series Forecasting with Anomalies**
  - 📅 2025-12-12 | 🏷️ `cs.LG, cs.AI, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.11526v1)

- **NeuralOGCM: Differentiable Ocean Modeling with Learnable Physics**
  - 📅 2025-12-12 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11525v1)
...
- **FloraForge: LLM-Assisted Procedural Generation of Editable and Analysis-Ready 3D Plant Geometric Models For Agricultural Applications**
  ...
  - [Read Paper](https://arxiv.org/abs/2512.11925v1)

- **CORL: Reinforcement Learning of MILP Policies Solved via Branch and Bound**
  - 📅 2025-12-11 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11169v1)

- **Image Tiling for High-Resolution Reasoning: Balancing Local Detail with Global Context**
  - 📅 2025-12-11 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11167v1)

- **Classifying High-Energy Celestial Objects with Machine Learning Methods**
  - 📅 2025-12-11 | 🏷️ `stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.11162v1)

- **Causal Judge Evaluation: Calibrated Surrogate Metrics for LLM Systems**
  - 📅 2025-12-11 | 🏷️ `stat.ME, stat.AP, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.11150v1)

- **MiniScope: A Least Privilege Framework for Authorizing Tool Calling Agents**
  - 📅 2025-12-11 | 🏷️ `cs.CR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11147v1)

- **Autoencoder-based Semi-Supervised Dimensionality Reduction and Clustering for Scientific Ensembles**
  - 📅 2025-12-11 | 🏷️ `cs.LG, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11145v1)

- **Learning complete and explainable visual representations from itemized text supervision**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11141v1)

- **Autotune: fast, accurate, and automatic tuning parameter selection for Lasso**
  - 📅 2025-12-11 | 🏷️ `stat.ME, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.11139v2)

- **The Vekua Layer: Exact Physical Priors for Implicit Neural Representations via Generalized Analytic Functions**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11138v1)

- **Fairness-Regularized Online Optimization with Switching Costs**
  - 📅 2025-12-11 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11131v1)

- **Fast-FoundationStereo: Real-Time Zero-Shot Stereo Matching**
  - 📅 2025-12-11 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.11130v1)
...
- **Refining Graphical Neural Network Predictions Using Flow Matching for Optimal Power Flow with Constraint-Satisfaction Guarantee**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11127v1)

- **Learning from a Generative Oracle: Domain Adaptation for Restoration**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11121v1)

- **In-Context Multi-Objective Optimization**
  - 📅 2025-12-11 | 🏷️ `cs.LG, cs.AI, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.11114v1)

- **FIBER: A Multilingual Evaluation Resource for Factual Inference Bias**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11110v1)

- **Limits and Gains of Test-Time Scaling in Vision-Language Reasoning**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11109v1)

- **Explanation Bias is a Product: Revealing the Hidden Lexical and Position Preferences in Post-Hoc Feature Attribution**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11108v1)

- **Information-driven Fusion of Pathology Foundation Models for Enhanced Disease Characterization**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11104v1)

- **VGent: Visual Grounding via Modular Design for Disentangling Reasoning and Prediction**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11099v1)

- **Vision-Language Models for Infrared Industrial Sensing in Additive Manufacturing Scene Description**
  - 📅 2025-12-11 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.11098v1)

- **Investigating ECG Diagnosis with Ambiguous Labels using Partial Label Learning**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11095v1)

- **Data-Driven Model Reduction using WeldNet: Windowed Encoders for Learning Dynamics**
  - 📅 2025-12-11 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11090v1)

- **TPV: Parameter Perturbations Through the Lens of Test Prediction Variance**
  - 📅 2025-12-11 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11089v1)

- **Clip-and-Verify: Linear Constraint-Driven Domain Clipping for Accelerating Neural Network Verification**
  - 📅 2025-12-11 | 🏷️ `cs.LG, cs.AI, cs.CR`
  - [Read Paper](https://arxiv.org/abs/2512.11087v1)

- **Memoryless Policy Iteration for Episodic POMDPs**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11082v1)

- **Provable Recovery of Locally Important Signed Features and Interactions from Random Forest**
  - 📅 2025-12-11 | 🏷️ `stat.ML, cs.LG, stat.ME`
  - [Read Paper](https://arxiv.org/abs/2512.11081v1)

- **Applying NLP to iMessages: Understanding Topic Avoidance, Responsiveness, and Sentiment**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.CY, stat.AP, stat.OT`
  - [Read Paper](https://arxiv.org/abs/2512.11079v1)

- **A probabilistic foundation model for crystal structure denoising, phase classification, and order parameters**
  - 📅 2025-12-11 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11077v1)

- **E-CHUM: Event-based Cameras for Human Detection and Urban Monitoring**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11076v1)

- **Fast, accurate measurement of the worker populations of honey bee colonies using deep learning**
  - 📅 2025-12-11 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11075v1)

- **MultiScript30k: Leveraging Multilingual Embeddings to Extend Cross Script Parallel Data**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.AI, cs.LG, cs.MM`
  - [Read Paper](https://arxiv.org/abs/2512.11074v1)

- **KathDB: Explainable Multimodal Database Management System with Human-AI Collaboration**
  - 📅 2025-12-11 | 🏷️ `cs.DB, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11067v1)

- **VDAWorld: World Modelling via VLM-Directed Abstraction and Simulation**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11061v1)

- **Synthetic Vasculature and Pathology Enhance Vision-Language Model Reasoning**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11060v1)

- **Weakly Supervised Tuberculosis Localization in Chest X-rays through Knowledge Distillation**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11057v1)

- **An Efficient Variant of One-Class SVM with Lifelong Online Learning Guarantees**
  - 📅 2025-12-11 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11052v1)

- **WholeBodyVLA: Towards Unified Latent VLA for Whole-Body Loco-Manipulation Control**
  - 📅 2025-12-11 | 🏷️ `cs.RO, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11047v2)

- **Towards Efficient and Effective Multi-Camera Encoding for End-to-End Driving**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10947v2)

- **Decoupled Q-Chunking**
  - 📅 2025-12-11 | 🏷️ `cs.LG, cs.AI, cs.RO, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.10926v2)

- **Iterative Compositional Data Generation for Robot Control**
  - 📅 2025-12-11 | 🏷️ `cs.RO, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10891v2)

- **SoccerMaster: A Vision Foundation Model for Soccer Understanding**
  - 📅 2025-12-11 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11016v1)

- **Vibe Coding in Practice: Flow, Technical Debt, and Guidelines for Sustainable Use**
  - 📅 2025-12-11 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11922v1)

- **From Macro to Micro: Benchmarking Microscopic Spatial Intelligence on Molecules via Vision-Language Models**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10867v2)

- **MMSI-Video-Bench: A Holistic Benchmark for Video-Based Spatial Intelligence**
  - 📅 2025-12-11 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10863v1)

- **Leveraging Text Guidance for Enhancing Demographic Fairness in Gender Classification**
  - 📅 2025-12-11 | 🏷️ `cs.CV, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11015v1)

- **SWiT-4D: Sliding-Window Transformer for Lossless and Parameter-Free Temporal 4D Generation**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10860v1)

- **Scaling Behavior of Discrete Diffusion Language Models**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10858v1)

- **Generative Modeling from Black-box Corruptions via Self-Consistent Stochastic Interpolants**
  - 📅 2025-12-11 | 🏷️ `cs.LG, cs.AI, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.10857v1)

- **Bayesian Symbolic Regression via Posterior Sampling**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10849v1)

- **PoseGAM: Robust Unseen Object Pose Estimation via Geometry-Aware Multi-View Reasoning**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10840v1)

- **Learning Controllable and Diverse Player Behaviors in Multi-Agent Environments**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10835v1)

- **An Elementary Proof of the Near Optimality of LogSumExp Smoothing**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10825v1)

- **V-OCBF: Learning Safety Filters from Offline Data via Value-Guided Offline Control Barrier Functions**
  - 📅 2025-12-11 | 🏷️ `cs.AI, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.10822v1)

- **Agile Deliberation: Concept Deliberation for Subjective Visual Classification**
  - 📅 2025-12-11 | 🏷️ `cs.AI, cs.CV, cs.HC, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10821v1)

- **Deep sets and event-level maximum-likelihood estimation for fast pile-up jet rejection in ATLAS**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10819v1)

- **Self-Ensemble Post Learning for Noisy Domain Generalization**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10818v1)

- **Extrapolation of Periodic Functions Using Binary Encoding of Continuous Numerical Values**
  - 📅 2025-12-11 | 🏷️ `cs.LG, cs.AI, cs.CV, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.10817v1)

- **Quantum Approaches to Urban Logistics: From Core QAOA to Clustered Scalability**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10813v1)

- **Graph Laplacian Transformer with Progressive Sampling for Prostate Cancer Grading**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10808v1)

- **PIAST: Rapid Prompting with In-context Augmentation for Scarce Training data**
  - 📅 2025-12-11 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.11013v1)

- **HAROOD: A Benchmark for Out-of-distribution Generalization in Sensor-based Human Activity Recognition**
  - 📅 2025-12-11 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10807v2)

- **Interpretable and Steerable Concept Bottleneck Sparse Autoencoders**
  - 📅 2025-12-11 | 🏷️ `cs.LG, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10805v1)

- **What matters for Representation Alignment: Global Information or Spatial Structure?**
  - 📅 2025-12-11 | 🏷️ `cs.CV, cs.AI, cs.GR, cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.10794v1)

- **LabelFusion: Learning to Fuse LLMs and Transformer Classifiers for Robust Text Classification**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10793v1)

- **The FACTS Leaderboard: A Comprehensive Benchmark for Large Language Model Factuality**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10791v1)

- **Natural Language Interface for Firewall Configuration**
  - 📅 2025-12-11 | 🏷️ `cs.NI, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10789v1)

- **Replace, Don't Expand: Mitigating Context Dilution in Multi-Hop RAG via Fixed-Budget Evidence Assembly**
  - 📅 2025-12-11 | 🏷️ `cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.10787v1)
...
- **Designing AI-Resilient Assessments Using Interconnected Problems: A Theoretically Grounded and Empirically Validated Framework**
  - 📅 2025-12-11 | 🏷️ `cs.CY, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10758v1)

- **OPV: Outcome-based Process Verifier for Efficient Long Chain-of-Thought Verification**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10756v1)

- **LDP: Parameter-Efficient Fine-Tuning of Multimodal LLM for Medical Report Generation**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10750v1)

- **CXL-SpecKV: A Disaggregated FPGA Speculative KV-Cache for Datacenter LLM Serving**
  - 📅 2025-12-11 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11920v1)

- **PMB-NN: Physiology-Centred Hybrid AI for Personalized Hemodynamic Monitoring from Photoplethysmography**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10745v1)

- **TRIDENT: A Redundant Architecture for Caribbean-Accented Emergency Speech Triage**
  - 📅 2025-12-11 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.10741v1)

- **Long-horizon Reasoning Agent for Olympiad-Level Mathematical Problem Solving**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10739v2)

- **LGAN: An Efficient High-Order Graph Neural Network via the Line Graph Aggregation**
  - 📅 2025-12-11 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10735v1)

- **Textual Data Bias Detection and Mitigation -- An Extensible Pipeline with Experimental Evaluation**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10734v2)

- **IRG-MotionLLM: Interleaving Motion Generation, Assessment and Refinement for Text-to-Motion Generation**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10730v1)

- **Video Depth Propagation**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10725v1)

- **Generalized Spherical Neural Operators: Green's Function Formulation**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10723v1)

- **Beyond the Black Box: Identifiable Interpretation and Control in Generative Models via Causal Minimality**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10720v1)

- **SpaceDrive: Infusing Spatial Awareness into VLM-based Autonomous Driving**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10719v1)

- **CheXmask-U: Quantifying uncertainty in landmark-based anatomical segmentation for X-ray images**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10715v1)

- **PACIFIC: a framework for generating benchmarks to check Precise Automatically Checked Instruction Following In Code**
  - 📅 2025-12-11 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10713v1)
...
- **Semantic Reconstruction of Adversarial Plagiarism: A Context-Aware Framework for Detecting and Restoring "Tortured Phrases" in Scientific Literature**
  - 📅 2025-12-11 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.10435v1)

- **Targeted Data Protection for Diffusion Model by Matching Training Trajectory**
  - 📅 2025-12-11 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10433v1)
...
- **Representation of the structure of graphs by sequences of instructions**
  - 📅 2025-12-11 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10429v2)

- **Renormalizable Spectral-Shell Dynamics as the Origin of Neural Scaling Laws**
  - 📅 2025-12-11 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10427v2)

- **Cooperative Retrieval-Augmented Generation for Question Answering: Mutual Information Exchange and Ranking by Contrasting Layers**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10422v2)

- **Neural Collapse in Test-Time Adaptation**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10421v1)

- **TransLocNet: Cross-Modal Attention for Aerial-Ground Vehicle Localization with Contrastive Learning**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10419v1)

- **Beyond Endpoints: Path-Centric Reasoning for Vectorized Off-Road Network Extraction**
  - 📅 2025-12-11 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10416v2)

- **How to Trick Your AI TA: A Systematic Study of Academic Jailbreaking in LLM Code Evaluation**
  - 📅 2025-12-11 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10415v1)

- **Boosting RL-Based Visual Reasoning with Selective Adversarial Entropy Intervention**
  - 📅 2025-12-11 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10414v1)

- **Sliding Window Attention Adaptation**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10411v2)

- **MultiHateLoc: Towards Temporal Localisation of Multimodal Hate Content in Online Videos**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10408v1)
...
- **Zero-shot Adaptation of Stable Diffusion via Plug-in Hierarchical Degradation Representation for Real-World Super-Resolution**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10340v1)

- **On the Collapse of Generative Paths: A Criterion and Correction for Diffusion Steering**
  - 📅 2025-12-11 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10339v1)

- **Multilingual VLM Training: Adapting an English-Trained VLM to French**
  - 📅 2025-12-11 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10336v1)
...
- **DualProtoSeg: Simple and Efficient Design with Text- and Image-Guided Prototype Learning for Weakly Supervised Histopathology Image Segmentation**
  - 📅 2025-12-11 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10314v1)

- **EpiPlanAgent: Agentic Automated Epidemic Response Planning**
  - 📅 2025-12-11 | 🏷️ `cs.AI, cs.CY`
  - [Read Paper](https://arxiv.org/abs/2512.10313v2)
...
- **CIEGAD: Cluster-Conditioned Interpolative and Extrapolative Framework for Geometry-Aware and Domain-Aligned Data Augmentation**
  ...
  - [Read Paper](https://arxiv.org/abs/2512.10178v1)

- **Offscript: Automated Auditing of Instruction Adherence in LLMs**
  - 📅 2025-12-11 | 🏷️ `cs.HC, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.10172v1)

- **Semantic-Aware Confidence Calibration for Automated Audio Captioning**
  - 📅 2025-12-11 | 🏷️ `cs.SD, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10170v1)

- **The 2025 Foundation Model Transparency Index**
  - 📅 2025-12-11 | 🏷️ `cs.AI, cs.CY, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10169v1)

- **Enhancing Large Language Models for End-to-End Circuit Analysis Problem Solving**
  - 📅 2025-12-10 | 🏷️ `cs.CY, cs.AI, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.10159v1)

- **Inference for Batched Adaptive Experiments**
  - 📅 2025-12-10 | 🏷️ `cs.LG, stat.ME`
  - [Read Paper](https://arxiv.org/abs/2512.10156v1)

- **Rethinking Causal Discovery Through the Lens of Exchangeability**
  - 📅 2025-12-10 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10152v1)

- **Topological Conditioning for Mammography Models via a Stable Wavelet-Persistence Vectorization**
  - 📅 2025-12-10 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.10151v1)

- **Unforgotten Safety: Preserving Safety Alignment of Large Language Models with Continual Learning**
  - 📅 2025-12-10 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10150v1)

- **STARS: Semantic Tokens with Augmented Representations for Recommendation at Scale**
  - 📅 2025-12-10 | 🏷️ `cs.IR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10149v2)

- **PARAN: Persona-Augmented Review ANswering system on Food Delivery Review Dataset**
  - 📅 2025-12-10 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10148v1)

- **Murmur2Vec: A Hashing Based Solution For Embedding Generation Of COVID-19 Spike Sequences**
  - 📅 2025-12-10 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10147v1)
...
- **Sequence-to-Image Transformation for Sequence Classification Using Rips Complex Construction and Chaos Game Representation**
  - 📅 2025-12-10 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10141v1)

- **Beyond Memristor: Neuromorphic Computing Using Meminductor**
  - 📅 2025-12-10 | 🏷️ `cs.ET, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11002v1)

- **Partitioning the Sample Space for a More Precise Shannon Entropy Estimation**
  - 📅 2025-12-10 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10133v1)

- **Universal Hirschberg for Width Bounded Dynamic Programs**
  - 📅 2025-12-10 | 🏷️ `cs.DS, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10132v1)

- **A Model-Guided Neural Network Method for the Inverse Scattering Problem**
  - 📅 2025-12-10 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10123v1)
...
- **DeepSeek's WEIRD Behavior: The cultural alignment of Large Language Models and the effects of prompt language and cultural prompting**
  - 📅 2025-12-10 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.09772v2)

- **MedBioRAG: Semantic Search and Retrieval-Augmented Generation with Large Language Models for Medical and Biological QA**
  - 📅 2025-12-10 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.10996v1)

- **Circuits, Features, and Heuristics in Molecular Transformers**
  - 📅 2025-12-10 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09757v1)

- **MOA: Multi-Objective Alignment for Role-Playing Agents**
  - 📅 2025-12-10 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.09756v1)

- **BAMBO: Construct Ability and Efficiency LLM Pareto Set via Bayesian Adaptive Multi-objective Block-wise Optimization**
  - 📅 2025-12-10 | 🏷️ `cs.LG, cs.CL, cs.NE`
  - [Read Paper](https://arxiv.org/abs/2512.09972v2)

- **Weird Generalization and Inductive Backdoors: New Ways to Corrupt LLMs**
  - 📅 2025-12-10 | 🏷️ `cs.CL, cs.AI, cs.CR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.09742v1)
...
- **A Clinically Interpretable Deep CNN Framework for Early Chronic Kidney Disease Prediction Using Grad-CAM-Based Explainable AI**
  - 📅 2025-12-10 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09244v1)

- **Training-free Context-adaptive Attention for Efficient Long Context Modeling**
  - 📅 2025-12-10 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.09238v1)

- **Efficient Feature Compression for Machines with Global Statistics Preservation**
  - 📅 2025-12-10 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.09235v1)

- **Enabling Next-Generation Consumer Experience with Feature Coding for Machines**
  - 📅 2025-12-10 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.09232v1)

- **Exploratory Mean-Variance with Jumps: An Equilibrium Approach**
  - 📅 2025-12-10 | 🏷️ `q-fin.PM, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.09224v1)

- **CORE: A Conceptual Reasoning Layer for Large Language Models**
  - 📅 2025-12-10 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09222v1)

- **View-on-Graph: Zero-shot 3D Visual Grounding via Vision-Language Reasoning on Scene Graphs**
  - 📅 2025-12-10 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.09215v1)

- **Targeting Misalignment: A Conflict-Aware Framework for Reward-Model-based LLM Alignment**
  - 📅 2025-12-10 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.09212v1)

- **Tensor-Compressed and Fully-Quantized Training of Neural PDE Solvers**
  - 📅 2025-12-10 | 🏷️ `cs.LG, cs.AI, cs.AR`
  - [Read Paper](https://arxiv.org/abs/2512.09202v1)

- **Residual Primitive Fitting of 3D Shapes with SuperFrusta**
  - 📅 2025-12-09 | 🏷️ `cs.GR, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.09201v1)

- **LLMs for Analog Circuit Design Continuum (ACDC)**
  - 📅 2025-12-09 | 🏷️ `cs.LG, cs.AI, cs.PF`
  - [Read Paper](https://arxiv.org/abs/2512.09199v1)

- **Towards Optimal Valve Prescription for Transcatheter Aortic Valve Replacement (TAVR) Surgery: A Machine Learning Approach**
  - 📅 2025-12-09 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09198v1)

- **Understanding Mental States in Active and Autonomous Driving with EEG**
  - 📅 2025-12-09 | 🏷️ `cs.HC, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09190v1)

- **WOLF: Werewolf-based Observations for LLM Deception and Falsehoods**
  - 📅 2025-12-09 | 🏷️ `cs.MA, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09187v1)

- **Learning Patient-Specific Disease Dynamics with Latent Flow Matching for Longitudinal Imaging Generation**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09185v2)

- **Understanding the Failure Modes of Transformers through the Lens of Graph Neural Networks**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.09182v1)

- **Prompt-Based Continual Compositional Zero-Shot Learning**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09172v1)

- **AI-Driven Expansion and Application of the Alexandria Database**
  - 📅 2025-12-09 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09169v1)

- **Spectral Embedding via Chebyshev Bases for Robust DeepONet Approximation**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.09165v1)

- **WonderZoom: Multi-Scale 3D World Generation**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.AI, cs.GR`
  - [Read Paper](https://arxiv.org/abs/2512.09164v1)

- **WTNN: Weibull-Tailored Neural Networks for survival analysis**
  - 📅 2025-12-09 | 🏷️ `stat.ML, cs.LG, stat.AP, stat.ME`
  - [Read Paper](https://arxiv.org/abs/2512.09163v1)

- **GTAvatar: Bridging Gaussian Splatting and Texture Mapping for Relightable and Editable Gaussian Avatars**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.GR`
  - [Read Paper](https://arxiv.org/abs/2512.09162v1)

- **Understanding temperature tuning in energy-based models**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.09152v1)

- **MindShift: Analyzing Language Models' Reactions to Psychological Prompts**
  - 📅 2025-12-09 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09149v1)

- **Detecting Hallucinations in Graph Retrieval-Augmented Generation via Attention Patterns and Semantic Alignment**
  - 📅 2025-12-09 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09148v1)

- **SDialog: A Python Toolkit for End-to-End Agent Building, User Simulation, Dialog Generation, and Evaluation**
  - 📅 2025-12-09 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09142v2)
...
- **Integrated Pipeline for Coronary Angiography With Automated Lesion Profiling, Virtual Stenting, and 100-Vessel FFR Validation**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09134v1)
...
- **SIP: Site in Pieces- A Dataset of Disaggregated Construction-Phase 3D Scans for Semantic Segmentation and Scene Understanding**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.09062v1)
...
- **All Emulators are Wrong, Many are Useful, and Some are More Useful Than Others: A Reproducible Comparison of Computer Model Surrogates**
  - 📅 2025-12-09 | 🏷️ `stat.CO, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.09060v1)

- **A Diffusion-Based Framework for High-Resolution Precipitation Forecasting over CONUS**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.09059v1)

- **ConceptPose: Training-Free Zero-Shot Object Pose Estimation using Concept Vectors**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.09056v1)

- **Improving Multi-Class Calibration through Normalization-Aware Isotonic Techniques**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.09054v1)

- **Monitoring Deployed AI Systems in Health Care**
  - 📅 2025-12-09 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09048v1)
...
- **Interpretable machine learning of halo gas density profiles: a sensitivity analysis of cosmological hydrodynamical simulations**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.09021v2)

- **Astra: General Interactive World Model with Autoregressive Denoising**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08931v2)

- **Learning to Remove Lens Flare in Event Camera**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.09016v1)

- **Selfi: Self Improving Reconstruction Engine via 3D Geometric Feature Alignment**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.GR`
  - [Read Paper](https://arxiv.org/abs/2512.08930v1)

- **Luxical: High-Speed Lexical-Dense Text Embeddings**
  - 📅 2025-12-09 | 🏷️ `cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.09015v2)

- **Efficiently Reconstructing Dynamic Scenes One D4RT at a Time**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08924v2)

- **Same Content, Different Answers: Cross-Modal Inconsistency in MLLMs**
  - 📅 2025-12-09 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08923v1)

- **Unified Diffusion Transformer for High-fidelity Text-Aware Image Restoration**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08922v1)

- **OSMO: Open-Source Tactile Glove for Human-to-Robot Skill Transfer**
  - 📅 2025-12-09 | 🏷️ `cs.RO, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08920v1)

- **SAQ: Stabilizer-Aware Quantum Error Correction Decoder**
  - 📅 2025-12-09 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08914v1)

- **LiDAS: Lighting-driven Dynamic Active Sensing for Nighttime Perception**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.08912v1)

- **Self-Evolving 3D Scene Generation from a Single Image**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08905v1)

- **UniLayDiff: A Unified Diffusion Transformer for Content-Aware Layout Generation**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08897v1)

- **Open Polymer Challenge: Post-Competition Report**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08896v1)

- **Unsupervised Learning of Density Estimates with Topological Optimization**
  - 📅 2025-12-09 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.08895v2)

- **Revisiting the Scaling Properties of Downstream Metrics in Large Language Model Training**
  - 📅 2025-12-09 | 🏷️ `cs.LG, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.08894v1)

- **Toward Faithful Retrieval-Augmented Generation with Sparse Autoencoders**
  - 📅 2025-12-09 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08892v1)

- **Graph Deep Learning for Intracranial Aneurysm Blood Flow Simulation and Risk Assessment**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.09013v1)

- **No Labels, No Problem: Training Visual Reasoners with Multimodal Verifiers**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08889v1)

- **Accelerated Rotation-Invariant Convolution for UAV Image Segmentation**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.08888v2)

- **An Approach for Detection of Entities in Dynamic Media Contents**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.09011v1)

- **Explainable Anomaly Detection for Industrial IoT Data Streams**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08885v1)

- **Decentralized Trust for Space AI: Blockchain-Based Federated Learning Across Multi-Vendor LEO Satellite Networks**
  - 📅 2025-12-09 | 🏷️ `cs.CR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08882v1)

- **SATGround: A Spatially-Aware Approach for Visual Grounding in Remote Sensing**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08881v1)

- **DAO-GP Drift Aware Online Non-Linear Regression Gaussian-Process**
  - 📅 2025-12-09 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08879v1)

- **When Tables Leak: Attacking String Memorization in LLM-Based Tabular Data Generation**
  - 📅 2025-12-09 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08875v1)

- **Siamese-Driven Optimization for Low-Resolution Image Latent Embedding in Image Captioning**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.AI, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.08873v1)

- **Fed-SE: Federated Self-Evolution for Privacy-Constrained Multi-Environment LLM Agents**
  - 📅 2025-12-09 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08870v1)

- **Differentially Private Synthetic Data Generation Using Context-Aware GANs**
  - 📅 2025-12-09 | 🏷️ `cs.LG, cs.AI, cs.CR`
  - [Read Paper](https://arxiv.org/abs/2512.08869v1)

- **EcomBench: Towards Holistic Evaluation of Foundation Agents in E-commerce**
  - 📅 2025-12-09 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08868v2)

- **Secure and Privacy-Preserving Federated Learning for Next-Generation Underground Mine Safety**
  - 📅 2025-12-09 | 🏷️ `cs.CR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08862v1)

- **Tri-Bench: Stress-Testing VLM Reliability on Spatial Reasoning under Camera Tilt and Object Interference**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08860v1)

- **Refining Diffusion Models for Motion Synthesis with an Acceleration Loss to Generate Realistic IMU Data**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08859v1)

- **Reinforcement Learning From State and Temporal Differences**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08855v1)

- **Generation is Required for Data-Efficient Perception**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08854v1)

- **Interpolation in Knowledge Representation**
  - 📅 2025-12-09 | 🏷️ `cs.AI, cs.LO`
  - [Read Paper](https://arxiv.org/abs/2512.08833v1)

- **Forecasting Fails: Unveiling Evasion Attacks in Weather Prediction Models**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08832v1)

- **InfiniteVL: Synergizing Linear and Sparse Attention for Highly-Efficient, Unlimited-Input Vision-Language Models**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08829v1)

- **Prediction Intervals for Individual Treatment Effects in a Multiple Decision Point Framework using Conformal Inference**
  - 📅 2025-12-09 | 🏷️ `stat.ME, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.08828v1)
...
- **C-DIRA: Computationally Efficient Dynamic ROI Routing and Domain-Invariant Adversarial Learning for Lightweight Driver Behavior Recognition**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08647v2)

- **QSTN: A Modular Framework for Robust Questionnaire Inference with Large Language Models**
  - 📅 2025-12-09 | 🏷️ `cs.CL, cs.CY`
  - [Read Paper](https://arxiv.org/abs/2512.08646v1)

- **Chain-of-Image Generation: Toward Monitorable and Controllable Image Generation**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08645v1)

- **Aerial Vision-Language Navigation with a Unified Framework for Spatial, Temporal and Embodied Reasoning**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08639v1)

- **See-Control: A Multimodal Agent Framework for Smartphone Interaction with a Robotic Arm**
  - 📅 2025-12-09 | 🏷️ `cs.AI, cs.CV, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.08629v1)

- **Trajectory Densification and Depth from Perspective-based Blur**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08627v1)

- **OpenMonoGS-SLAM: Monocular Gaussian Splatting SLAM with Open-set Semantics**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08625v1)

- **HealthcareNLP: where are we and what is next?**
  - 📅 2025-12-09 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.08617v1)

- **Protein Secondary Structure Prediction Using Transformers**
  - 📅 2025-12-09 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08613v1)
...
- **CogMCTS: A Novel Cognitive-Guided Monte Carlo Tree Search Framework for Iterative Heuristic Evolution with Large Language Models**
  - 📅 2025-12-09 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08609v2)

- **Decoupling Template Bias in CLIP: Harnessing Empty Prompts for Enhanced Few-Shot Learning**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08606v2)

- **Heuristics for Combinatorial Optimization via Value-based Reinforcement Learning: A Unified Framework and Analysis**
  - 📅 2025-12-09 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08601v1)
...
- **A Lightweight Transfer Learning-Based State-of-Health Monitoring with Application to Lithium-ion Batteries in Autonomous Air Vehicles**
  - 📅 2025-12-09 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08512v2)

- **Thinking with Images via Self-Calling Agent**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08511v2)
...
- **Developing Distance-Aware Uncertainty Quantification Methods in Physics-Guided Neural Networks for Reliable Bearing Health Prediction**
  - 📅 2025-12-09 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08499v1)

- **On-the-fly Large-scale 3D Reconstruction from Multi-Camera Rigs**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08498v1)

- **LLM-based Vulnerable Code Augmentation: Generate or Refactor?**
  - 📅 2025-12-09 | 🏷️ `cs.CR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08493v1)

- **Autonomous Issue Resolver: Towards Zero-Touch Code Maintenance**
  - 📅 2025-12-09 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08492v1)

- **Temporal Concept Dynamics in Diffusion Models via Prompt-Conditioned Interventions**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08486v1)

- **Optimal Perturbation Budget Allocation for Data Poisoning in Offline Reinforcement Learning**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08485v2)
...
- **Transformers for Multimodal Brain State Decoding: Integrating Functional Magnetic Resonance Imaging Data and Medical Metadata**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08462v1)
...
- **Ontology-Based Knowledge Graph Framework for Industrial Standard Documents via Hierarchical and Propositional Structuring**
  - 📅 2025-12-09 | 🏷️ `cs.IR, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.08398v1)

- **Detection of Digital Facial Retouching utilizing Face Beauty Information**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08397v1)
...
- **Persistent Topological Structures and Cohomological Flows as a Mathematical Framework for Brain-Inspired Representation Learning**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08241v1)

- **HybridToken-VLM: Hybrid Token Compression for Vision-Language Models**
  - 📅 2025-12-09 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08240v1)

- **SpeechQualityLLM: LLM-Based Multimodal Assessment of Speech Quality**
  - 📅 2025-12-09 | 🏷️ `cs.SD, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08238v1)

- **FastBEV++: Fast by Algorithm, Deployable by Design**
  - 📅 2025-12-09 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08237v1)
...
- **LayerPipe2: Multistage Pipelining and Weight Recompute via Improved Exponential Moving Average for Training Neural Networks**
  - 📅 2025-12-09 | 🏷️ `cs.LG, cs.AI, cs.AR`
  - [Read Paper](https://arxiv.org/abs/2512.08160v1)

- **TreeGRPO: Tree-Advantage GRPO for Online RL Post-Training of Diffusion Models**
  - 📅 2025-12-09 | 🏷️ `cs.LG, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08153v1)

- **Scalable Back-End for an AI-Based Diabetes Prediction Application**
  - 📅 2025-12-09 | 🏷️ `cs.AI, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.08147v1)

- **Chat with UAV -- Human-UAV Interaction Based on Large Language Models**
  - 📅 2025-12-09 | 🏷️ `cs.RO, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08145v1)

- **PolyLingua: Margin-based Inter-class Transformer for Robust Cross-domain Language Detection**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08143v2)
...
- **DermETAS-SNA LLM: A Dermatology Focused Evolutionary Transformer Architecture Search with StackNet Augmented LLM Assistant**
  - 📅 2025-12-09 | 🏷️ `cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08998v1)

- **Robust Agents in Open-Ended Worlds**
  - 📅 2025-12-09 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08139v1)

- **Robust equilibria in continuous games: From strategic to dynamic robustness**
  - 📅 2025-12-09 | 🏷️ `cs.GT, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08138v1)
...
- **CLARITY: Medical World Model for Guiding Treatment Decisions by Modeling Context-Aware Disease Trajectories in Latent Space**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.08029v1)

- **Toward an AI Reasoning-Enabled System for Patient-Clinical Trial Matching**
  - 📅 2025-12-08 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08026v1)

- **Provable Diffusion Posterior Sampling for Bayesian Inversion**
  - 📅 2025-12-08 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08022v1)

- **FRIEDA: Benchmarking Multi-Step Cartographic Reasoning in Vision-Language Models**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08016v1)

- **Learning Dynamics from Infrequent Output Measurements for Uncertainty-Aware Optimal Control**
  - 📅 2025-12-08 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08013v1)

- **Benchmarking Offline Multi-Objective Reinforcement Learning in Critical Care**
  - 📅 2025-12-08 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08012v1)

- **Beyond Unified Models: A Service-Oriented Approach to Low Latency, Context Aware Phonemization for Real Time TTS**
  - 📅 2025-12-08 | 🏷️ `cs.SD, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.08006v1)

- **DIJIT: A Robotic Head for an Active Observer**
  - 📅 2025-12-08 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07998v1)

- **A Comparative Study of EMG- and IMU-based Gesture Recognition at the Wrist and Forearm**
  - 📅 2025-12-08 | 🏷️ `cs.HC, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07997v1)

- **SkipKV: Selective Skipping of KV Generation and Storage for Efficient Inference with Large Reasoning Models**
  - 📅 2025-12-08 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07993v1)
...
- **Bridging the Clinical Expertise Gap: Development of a Web-Based Platform for Accessible Time Series Forecasting and Analysis**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.07992v1)

- **A Gray Literature Study on Fairness Requirements in AI-enabled Software Engineering**
  - 📅 2025-12-08 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07990v1)

- **HOLE: Homological Observation of Latent Embeddings for Neural Network Interpretability**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.GR, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.07988v2)

- **Restrictive Hierarchical Semantic Segmentation for Stratified Tooth Layer Detection**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07984v1)

- **An Empirical Framework for Evaluating Semantic Preservation Using Hugging Face**
  - 📅 2025-12-08 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07983v1)

- **CIP-Net: Continual Interpretable Prototype-based Network**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07981v1)

- **VLD: Visual Language Goal Distance for Reinforcement Learning Navigation**
  - 📅 2025-12-08 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07976v1)

- **Sparse Variable Projection in Robotic Perception: Exploiting Separable Structure for Efficient Nonlinear Optimization**
  - 📅 2025-12-08 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07969v1)

- **Towards symbolic regression for interpretable clinical decision scores**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.NE`
  - [Read Paper](https://arxiv.org/abs/2512.07961v1)

- **Preserving Source Video Realism: High-Fidelity Face Swapping for Cinematic Quality**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07951v1)

- **Conformal Defects in Neural Network Field Theories**
  - 📅 2025-12-08 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07946v1)

- **Voxify3D: Pixel Art Meets Volumetric Rendering**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07834v1)

- **Relational Visual Similarity**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07833v1)

- **Do Generalisation Results Generalise?**
  - 📅 2025-12-08 | 🏷️ `cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07832v1)

- **UnityVideo: Unified Multi-Modal Multi-Task Learning for Enhancing World-Aware Video Generation**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07831v1)

- **Can AI autonomously build, operate, and use the entire data stack?**
  - 📅 2025-12-08 | 🏷️ `cs.AI, cs.DB, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07926v1)

- **One Layer Is Enough: Adapting Pretrained Visual Encoders for Image Generation**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07829v2)

- **The Adoption and Usage of AI Agents: Early Evidence from Perplexity**
  - 📅 2025-12-08 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07828v2)

- **Near-real time fires detection using satellite imagery in Sudan conflict**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07925v1)

- **An Adaptive Multi-Layered Honeynet Architecture for Threat Behavior Analysis via Deep Learning**
  - 📅 2025-12-08 | 🏷️ `cs.CR, cs.DC, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07827v1)

- **OpenVE-3M: A Large-Scale High-Quality Dataset for Instruction-Guided Video Editing**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07826v2)
...
- **Graph-Based Learning of Spectro-Topographical EEG Representations with Gradient Alignment for Brain-Computer Interfaces**
  - 📅 2025-12-08 | 🏷️ `cs.HC, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07820v1)

- **Provable Long-Range Benefits of Next-Token Prediction**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.AI, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.07818v1)

- **Understanding Privacy Risks in Code Models Through Training Dynamics: A Causal Approach**
  - 📅 2025-12-08 | 🏷️ `cs.SE, cs.AI, cs.CR`
  - [Read Paper](https://arxiv.org/abs/2512.07814v2)

- **Auditing Games for Sandbagging**
  - 📅 2025-12-08 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07810v1)

- **LUNA: LUT-Based Neural Architecture for Fast and Low-Cost Qubit Readout**
  - 📅 2025-12-08 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07808v1)

- **Lang3D-XL: Language Embedded 3D Gaussians for Large-scale Scenes**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.GR`
  - [Read Paper](https://arxiv.org/abs/2512.07807v1)

- **Multi-view Pyramid Transformer: Look Coarser to See Broader**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07806v1)

- **Group Representational Position Encoding**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.07805v1)

- **OneStory: Coherent Multi-Shot Video Generation with Adaptive Memory**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07802v1)

- **Collaborative Causal Sensemaking: Closing the Complementarity Gap in Human-AI Decision Support**
  - 📅 2025-12-08 | 🏷️ `cs.CL, cs.AI, cs.HC, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07801v3)

- **Large Causal Models from Large Language Models**
  - 📅 2025-12-08 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07796v1)

- **ReasonBENCH: Benchmarking the (In)Stability of LLM Reasoning**
  - 📅 2025-12-08 | 🏷️ `cs.AI, cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07795v1)

- **Automating High Energy Physics Data Analysis with LLM-Powered Agents**
  - 📅 2025-12-08 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07785v1)

- **On the Interplay of Pre-Training, Mid-Training, and RL on Reasoning Language Models**
  - 📅 2025-12-08 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.07783v1)

- **GatedFWA: Linear Flash Windowed Attention with Gated Associative Memory**
  - 📅 2025-12-08 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07782v1)

- **Distribution Matching Variational AutoEncoder**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07778v1)

- **Mary, the Cheeseburger-Eating Vegetarian: Do LLMs Recognize Incoherence in Narratives?**
  - 📅 2025-12-08 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.07777v1)

- **GorillaWatch: An Automated System for In-the-Wild Gorilla Re-Identification and Population Monitoring**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07776v1)

- **Distribution-informed Online Conformal Prediction**
  - 📅 2025-12-08 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07770v1)

- **Formalized Hopfield Networks and Boltzmann Machines**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.LO`
  - [Read Paper](https://arxiv.org/abs/2512.07766v1)

- **RL-MTJail: Reinforcement Learning for Automated Black-Box Multi-Turn Jailbreaking of Large Language Models**
  - 📅 2025-12-08 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07761v1)

- **Modality-Aware Bias Mitigation and Invariance Learning for Unsupervised Visible-Infrared Person Re-Identification**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07760v1)

- **UltrasODM: A Dual Stream Optical Flow Mamba Network for 3D Freehand Ultrasound Reconstruction**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.07756v1)

- **Physics-Informed Neural Networks for Source Inversion and Parameters Estimation in Atmospheric Dispersion**
  - 📅 2025-12-08 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07755v1)

- **Unison: A Fully Automatic, Task-Universal, and Low-Cost Framework for Unified Understanding and Generation**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07747v1)

- **DiffusionDriveV2: Reinforcement Learning-Constrained Truncated Diffusion Modeling in End-to-End Autonomous Driving**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07745v1)

- **A multimodal Bayesian Network for symptom-level depression and anxiety prediction from voice and speech data**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.SD`
  - [Read Paper](https://arxiv.org/abs/2512.07741v1)

- **HLTCOE Evaluation Team at TREC 2025: VQA Track**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07738v1)
...
- **SpatialDreamer: Incentivizing Spatial Reasoning via Active Mental Imagery**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07733v1)

- **SAVE: Sparse Autoencoder-Driven Visual Information Enhancement for Mitigating Object Hallucination**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07730v2)

- **Improving action classification with brain-inspired deep networks**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07729v1)

- **The Native Spiking Microarchitecture: From Iontronic Primitives to Bit-Exact FP8 Arithmetic**
  - 📅 2025-12-08 | 🏷️ `cs.ET, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07724v1)

- **Enabling Delayed-Full Charging Through Transformer-Based Real-Time-to-Departure Modeling for EV Battery Longevity**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07723v2)

- **ViSA: 3D-Aware Video Shading for Real-Time Upper-Body Avatar Creation**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07720v2)

- **UnCageNet: Tracking and Pose Estimation of Caged Animal**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07712v2)

- **Each Prompt Matters: Scaling Reinforcement Learning Without Wasting Rollouts on Hundred-Billion-Scale MoE**
  - 📅 2025-12-08 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07710v1)

- **In-Context and Few-Shots Learning for Forecasting Time Series Data based on Large Language Models**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07705v1)

- **PVeRA: Probabilistic Vector-Based Random Matrix Adaptation**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07703v1)

- **Demo: Generative AI helps Radiotherapy Planning with User Preference**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08996v1)

- **Guiding What Not to Generate: Automated Negative Prompting for Text-Image Alignment**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07702v2)

- **sim2art: Accurate Articulated Object Modeling from a Single Video using Synthetic Training Data Only**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.07698v1)
...
- **Automated Generation of Custom MedDRA Queries Using SafeTerm Medical Map**
  - 📅 2025-12-08 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.07694v1)

- **HalluShift++: Bridging Language and Vision through Internal Representation Shifts for Hierarchical Hallucinations in MLLMs**
  - 📅 2025-12-08 | 🏷️ `cs.CL, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07687v1)

- **When Large Language Models Do Not Work: Online Incivility Prediction through Graph Neural Networks**
  - 📅 2025-12-08 | 🏷️ `cs.CL, cs.AI, cs.SI`
  - [Read Paper](https://arxiv.org/abs/2512.07684v1)

- **A Bootstrap Perspective on Stochastic Gradient Descent**
  - 📅 2025-12-08 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.07676v1)

- **DIST-CLIP: Arbitrary Metadata and Image Guided MRI Harmonization via Disentangled Anatomy-Contrast Representations**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07674v1)

- **DeepCode: Open Agentic Coding**
  - 📅 2025-12-08 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07921v1)

- **EgoCampus: Egocentric Pedestrian Eye Gaze Model and Dataset**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07668v1)

- **Depth-Wise Activation Steering for Honest Language Models**
  - 📅 2025-12-08 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07667v1)

- **Bridging Code Graphs and Large Language Models for Better Code Understanding**
  - 📅 2025-12-08 | 🏷️ `cs.CL, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.07666v1)

- **Optimization-Guided Diffusion for Interactive Scene Generation**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07661v2)

- **An AI-Powered Autonomous Underwater System for Sea Exploration and Scientific Research**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07652v1)

- **Liver Fibrosis Quantification and Analysis: The LiQA Dataset and Baseline Method**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07651v1)

- **Exploring Test-time Scaling via Prediction Merging on Large-Scale Recommendation**
  - 📅 2025-12-08 | 🏷️ `cs.IR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07650v1)

- **A Mathematical Theory of Top-$k$ Sparse Attention via Total Variation Distance**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07647v1)

- **The Agent Capability Problem: Predicting Solvability Through Information-Theoretic Bounds**
  - 📅 2025-12-08 | 🏷️ `cs.AI, cs.CC, cs.IT, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07631v1)

- **MoCA: Mixture-of-Components Attention for Scalable Compositional 3D Generation**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07628v1)

- **Incorporating Structure and Chord Constraints in Symbolic Transformer-based Melodic Harmonization**
  - 📅 2025-12-08 | 🏷️ `cs.SD, cs.AI, cs.SC`
  - [Read Paper](https://arxiv.org/abs/2512.07627v1)

- **Time Series Foundation Models for Process Model Forecasting**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07624v1)

- **PCMind-2.1-Kaiyuan-2B Technical Report**
  - 📅 2025-12-08 | 🏷️ `cs.CL, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07612v1)

- **Comparative Analysis and Parametric Tuning of PPO, GRPO, and DAPO for LLM Reasoning Enhancement**
  - 📅 2025-12-08 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07611v1)

- **Metric-Fair Prompting: Treating Similar Samples Similarly**
  - 📅 2025-12-08 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07608v1)
...
- **Most over-representation of phonological features in basic vocabulary disappears when controlling for spatial and phylogenetic effects**
  - 📅 2025-12-08 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.07543v1)

- **RRAEDy: Adaptive Latent Linearization of Nonlinear Dynamical Systems**
  - 📅 2025-12-08 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07542v1)

- **High-Dimensional Change Point Detection using Graph Spanning Ratio**
  - 📅 2025-12-08 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07541v1)

- **Minimum Bayes Risk Decoding for Error Span Detection in Reference-Free Automatic Machine Translation Evaluation**
  - 📅 2025-12-08 | 🏷️ `cs.CL, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07540v1)

- **FRWKV:Frequency-Domain Linear Attention for Long-Term Time Series Forecasting**
  - 📅 2025-12-08 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07539v2)

- **SwissGov-RSD: A Human-annotated, Cross-lingual Benchmark for Token-level Recognition of Semantic Differences Between Related Documents**
  - 📅 2025-12-08 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.07538v1)

- **VulnLLM-R: Specialized Reasoning LLM with Agent Scaffold for Vulnerability Detection**
  - 📅 2025-12-08 | 🏷️ `cs.CR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07533v1)

- **Model-Based Reinforcement Learning Under Confounding**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07528v1)

- **From Orbit to Ground: Generative City Photogrammetry from Extreme Off-Nadir Satellite Images**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.GR`
  - [Read Paper](https://arxiv.org/abs/2512.07527v2)

- **Beyond Real: Imaginary Extension of Rotary Position Embeddings for Long-Context LLMs**
  - 📅 2025-12-08 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.07525v1)

- **LIME: Making LLM Data More Efficient with Linguistic Metadata Embeddings**
  - 📅 2025-12-08 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07522v1)

- **Machine Learning: Progress and Prospects**
  - 📅 2025-12-08 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07519v1)

- **An Experience Report on a Pedagogically Controlled, Curriculum-Constrained AI Tutor for SE Education**
  - 📅 2025-12-08 | 🏷️ `cs.CY, cs.AI, cs.HC, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.11882v1)

- **SPAD: Seven-Source Token Probability Attribution with Syntactic Aggregation for Detecting Hallucinations in RAG**
  - 📅 2025-12-08 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07515v1)

- **MeshRipple: Structured Autoregressive Generation of Artist-Meshes**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07514v2)

- **Exploring possible vector systems for faster training of neural networks with preconfigured latent spaces**
  - 📅 2025-12-08 | 🏷️ `cs.LG, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07509v2)

- **ControlVP: Interactive Geometric Refinement of AI-Generated Images with Consistent Vanishing Points**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07504v1)

- **SJD++: Improved Speculative Jacobi Decoding for Training-free Acceleration of Discrete Auto-regressive Text-to-Image Generation**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07503v1)

- **AutoICE: Automatically Synthesizing Verifiable C Code via LLM-driven Evolution**
  - 📅 2025-12-08 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07501v1)

- **MultiMotion: Multi Subject Video Motion Transfer via Video Diffusion Transformer**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07500v2)
...
- **Towards Robust DeepFake Detection under Unstable Face Sequences: Adaptive Sparse Graph Embedding with Order-Free Representation and Explicit Laplacian Spectral Prior**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07498v1)
...
- **A Neural Affinity Framework for Abstract Reasoning: Diagnosing the Compositional Gap in Transformer Architectures via Procedural Task Taxonomy**
  - 📅 2025-12-08 | 🏷️ `cs.AI, cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07109v1)
...
- **COREA: Coarse-to-Fine 3D Representation Alignment Between Relightable 3D Gaussians and SDF via Bidirectional 3D-to-3D Supervision**
  - 📅 2025-12-08 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07107v2)

- **Deterministic World Models for Verification of Closed-loop Vision-based Systems**
  - 📅 2025-12-08 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08991v1)
...
- **DAUNet: A Lightweight UNet Variant with Deformable Convolutions and Parameter-Free Attention for Medical Image Segmentation**
  - 📅 2025-12-07 | 🏷️ `cs.CV, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07051v1)
...
- **Transformation of Biological Networks into Images via Semantic Cartography for Visual Interpretation and Scalable Deep Analysis**
  - 📅 2025-12-07 | 🏷️ `cs.LG, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.07040v1)

- **Ideal Attribution and Faithful Watermarks for Language Models**
  - 📅 2025-12-07 | 🏷️ `cs.CR, cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.07038v1)

- **Evaluating and Preserving High-level Fidelity in Super-Resolution**
  - 📅 2025-12-07 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07037v2)
...
- **Power of Boundary and Reflection: Semantic Transparent Object Segmentation using Pyramid Vision Transformer with Transparent Cues**
  - 📅 2025-12-07 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07034v1)
...
- **A Comprehensive Study of Supervised Machine Learning Models for Zero-Day Attack Detection: Analyzing Performance on Imbalanced Data**
  - 📅 2025-12-07 | 🏷️ `cs.CR, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07030v1)

- **LoopBench: Discovering Emergent Symmetry Breaking Strategies with LLM Swarms**
  - 📅 2025-12-07 | 🏷️ `cs.AI, cs.LG, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.13713v1)

- **Reformulate, Retrieve, Localize: Agents for Repository-Level Bug Localization**
  - 📅 2025-12-07 | 🏷️ `cs.SE, cs.AI, cs.IR`
  - [Read Paper](https://arxiv.org/abs/2512.07022v1)

- **Transferring Clinical Knowledge into ECGs Representation**
  - 📅 2025-12-07 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07021v1)

- **Latency-Response Theory Model: Evaluating Large Language Models via Response Accuracy and Chain-of-Thought Length**
  - 📅 2025-12-07 | 🏷️ `stat.ME, cs.AI, stat.AP, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.07019v2)

- **It's About Time: The Temporal and Modal Dynamics of Copilot Usage**
  - 📅 2025-12-07 | 🏷️ `cs.CY, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11879v1)

- **FVA-RAG: Falsification-Verification Alignment for Mitigating Sycophantic Hallucinations**
  - 📅 2025-12-07 | 🏷️ `cs.CL, cs.AI, cs.IR`
  - [Read Paper](https://arxiv.org/abs/2512.07015v1)

- **Block Sparse Flash Attention**
  - 📅 2025-12-07 | 🏷️ `cs.LG, cs.CL, cs.PF`
  - [Read Paper](https://arxiv.org/abs/2512.07011v1)

- **Always Keep Your Promises: DynamicLRP, A Model-Agnostic Solution To Layer-Wise Relevance Propagation**
  - 📅 2025-12-07 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07010v1)

- **Optimizing video analytics inference pipelines: a case study**
  - 📅 2025-12-07 | 🏷️ `cs.DC, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.07009v1)

- **Multi-Accent Mandarin Dry-Vocal Singing Dataset: Benchmark for Singing Accent Recognition**
  - 📅 2025-12-07 | 🏷️ `cs.SD, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07005v1)

- **Benchmarking Deep Neural Networks for Modern Recommendation Systems**
  - 📅 2025-12-07 | 🏷️ `cs.IR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.07000v1)

- **Singing Timbre Popularity Assessment Based on Multimodal Large Foundation Model**
  - 📅 2025-12-07 | 🏷️ `cs.SD, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06999v1)

- **Toward Reliable Machine Unlearning: Theory, Algorithms, and Evaluation**
  - 📅 2025-12-07 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06993v1)

- **Prompting-in-a-Series: Psychology-Informed Contents and Embeddings for Personality Recognition With Decoder-Only Models**
  - 📅 2025-12-07 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06991v1)
...
- **Utilizing Multi-Agent Reinforcement Learning with Encoder-Decoder Architecture Agents to Identify Optimal Resection Location in Glioblastoma Multiforme Patients**
  - 📅 2025-12-07 | 🏷️ `cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06990v1)

- **Flash Multi-Head Feed-Forward Network**
  - 📅 2025-12-07 | 🏷️ `cs.LG, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.06989v1)

- **OXtal: An All-Atom Diffusion Model for Organic Crystal Structure Prediction**
  - 📅 2025-12-07 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06987v1)

- **On Memory: A comparison of memory mechanisms in world models**
  - 📅 2025-12-07 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06983v1)

- **LLM-Driven Composite Neural Architecture Search for Multi-Source RL State Encoding**
  - 📅 2025-12-07 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06982v2)

- **Selective Masking based Self-Supervised Learning for Image Semantic Segmentation**
  - 📅 2025-12-07 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06981v1)

- **Physics-Guided Diffusion Priors for Multi-Slice Reconstruction in Scientific Imaging**
  - 📅 2025-12-07 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06977v1)

- **Learning Robust and Correct Controllers Guided by Feasibility-Aware Signal Temporal Logic via BarrierNet**
  - 📅 2025-12-07 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06973v2)

- **Prediction with Expert Advice under Local Differential Privacy**
  - 📅 2025-12-07 | 🏷️ `cs.LG, cs.CR, cs.DS, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.06971v1)

- **Comparing BFGS and OGR for Second-Order Optimization**
  - 📅 2025-12-07 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06969v1)

- **VideoVLA: Video Generators Can Be Generalizable Robot Manipulators**
  - 📅 2025-12-07 | 🏷️ `cs.RO, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06963v1)

- **Learning Conditional Independence Differential Graphs From Time-Dependent Data**
  - 📅 2025-12-07 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06960v1)

- **ELANA: A Simple Energy and Latency Analyzer for LLMs**
  - 📅 2025-12-07 | 🏷️ `cs.DC, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.09946v1)

- **Statistical analysis of Inverse Entropy-regularized Reinforcement Learning**
  - 📅 2025-12-07 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06956v1)

- **Task adaptation of Vision-Language-Action model: 1st Place Solution for the 2025 BEHAVIOR Challenge**
  - 📅 2025-12-07 | 🏷️ `cs.RO, cs.AI, cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06951v1)

- **PARIS: Pruning Algorithm via the Representer theorem for Imbalanced Scenarios**
  - 📅 2025-12-07 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06950v1)
...
- **Parent-Guided Semantic Reward Model (PGSRM): Embedding-Based Reward Functions for Reinforcement Learning of Transformer Language Models**
  - 📅 2025-12-07 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06920v1)

- **Automated PRO-CTCAE Symptom Selection based on Prior Adverse Event Profiles**
  - 📅 2025-12-07 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.06919v1)

- **Know your Trajectory -- Trustworthy Reinforcement Learning deployment through Importance-Based Trajectory Analysis**
  - 📅 2025-12-07 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06917v1)

- **SoK: Trust-Authorization Mismatch in LLM Agent Interactions**
  - 📅 2025-12-07 | 🏷️ `cs.CR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06914v1)

- **Khalasi: Energy-Efficient Navigation for Surface Vehicles in Vortical Flow Fields**
  - 📅 2025-12-07 | 🏷️ `cs.RO, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06912v2)

- **MINES: Explainable Anomaly Detection through Web API Invariant Inference**
  - 📅 2025-12-07 | 🏷️ `cs.SE, cs.CR, cs.DB, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06906v1)

- **Scaling Zero-Shot Reference-to-Video Generation**
  - 📅 2025-12-07 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06905v1)

- **BabelCoder: Agentic Code Translation with Specification Alignment**
  - 📅 2025-12-07 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06902v1)

- **Overcoming Small Data Limitations in Video-Based Infant Respiration Estimation**
  - 📅 2025-12-07 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06888v1)

- **Balanced Learning for Domain Adaptive Semantic Segmentation**
  - 📅 2025-12-07 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06886v1)

- **JoPano: Unified Panorama Generation via Joint Modeling**
  - 📅 2025-12-07 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06885v1)

- **Hierarchical Image-Guided 3D Point Cloud Segmentation in Industrial Scenes via Multi-View Bayesian Fusion**
  - 📅 2025-12-07 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06882v1)

- **WisPaper: Your AI Scholar Search Engine**
  - 📅 2025-12-07 | 🏷️ `cs.IR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06879v1)

- **SceneMixer: Exploring Convolutional Mixing Networks for Remote Sensing Scene Classification**
  - 📅 2025-12-07 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06877v1)

- **An Analysis of Large Language Models for Simulating User Responses in Surveys**
  - 📅 2025-12-07 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.06874v1)

- **Towards Robust Pseudo-Label Learning in Semantic Segmentation: An Encoding Perspective**
  - 📅 2025-12-07 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06870v1)

- **Rhea: Role-aware Heuristic Episodic Attention for Conversational LLMs**
  - 📅 2025-12-07 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.06869v1)

- **Dynamic Visual SLAM using a General 3D Prior**
  - 📅 2025-12-07 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06868v1)

- **Do Persona-Infused LLMs Affect Performance in a Strategic Reasoning Game?**
  - 📅 2025-12-07 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06867v1)

- **Less Is More, but Where? Dynamic Token Compression via LLM-Guided Keyframe Prior**
  - 📅 2025-12-07 | 🏷️ `cs.CV, cs.AI, cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06866v1)

- **Spatial Retrieval Augmented Autonomous Driving**
  - 📅 2025-12-07 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06865v1)

- **Boosting Unsupervised Video Instance Segmentation with Automatic Quality-Guided Self-Training**
  - 📅 2025-12-07 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06864v1)

- **Omni-Referring Image Segmentation**
  - 📅 2025-12-07 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06862v1)

- **The Art of Storytelling in Authoritarian Regimes: Crafting State Narratives on Chinese Social Media**
  - 📅 2025-12-07 | 🏷️ `cs.CY, cs.LG, stat.AP`
  - [Read Paper](https://arxiv.org/abs/2512.11875v1)

- **JT-DA: Enhancing Data Analysis with Tool-Integrated Table Reasoning Large Language Models**
  - 📅 2025-12-07 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06859v1)

- **ArchPower: Dataset for Architecture-Level Power Modeling of Modern CPU Design**
  - 📅 2025-12-07 | 🏷️ `cs.AR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06854v1)

- **Formal that "Floats" High: Formal Verification of Floating Point Arithmetic**
  - 📅 2025-12-07 | 🏷️ `cs.LO, cs.AI, cs.AR`
  - [Read Paper](https://arxiv.org/abs/2512.06850v1)

- **Hide-and-Seek Attribution: Weakly Supervised Segmentation of Vertebral Metastases in CT**
  - 📅 2025-12-07 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06849v1)
...
- **Arc Gradient Descent: A Mathematically Derived Reformulation of Gradient Descent with Phase-Aware, User-Controlled Step Dynamics**
  - 📅 2025-12-07 | 🏷️ `cs.LG, cs.AI, cs.CL, cs.CV, cs.NE`
  - [Read Paper](https://arxiv.org/abs/2512.06737v1)
...
- **DEFEND: Poisoned Model Detection and Malicious Client Exclusion Mechanism for Secure Federated Learning-based Road Condition Classification**
  - 📅 2025-12-05 | 🏷️ `cs.CR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06172v1)

- **Automated Annotation of Shearographic Measurements Enabling Weakly Supervised Defect Detection**
  - 📅 2025-12-05 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06171v1)
...
- **Morphologically-Informed Tokenizers for Languages with Non-Concatenative Morphology: A case study of Yoloxóchtil Mixtec ASR**
  - 📅 2025-12-05 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.06169v1)
...
- **Deep learning for autism detection using clinical notes: A comparison of transfer learning for a transparent and black-box approach**
  - 📅 2025-12-05 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06161v1)

- **Tracking-Guided 4D Generation: Foundation-Tracker Motion Priors for 3D Model Animation**
  - 📅 2025-12-05 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06158v1)

- **Learning Invariant Graph Representations Through Redundant Information**
  - 📅 2025-12-05 | 🏷️ `cs.LG, cs.AI, cs.IT`
  - [Read Paper](https://arxiv.org/abs/2512.06154v1)

- **GuideNav: User-Informed Development of a Vision-Only Robotic Navigation Assistant For Blind Travelers**
  - 📅 2025-12-05 | 🏷️ `cs.RO, cs.CV, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.06147v1)

- **gp2Scale: A Class of Compactly-Supported Non-Stationary Kernels and Distributed Computing for Exact Gaussian Processes on 10 Million Data Points**
  - 📅 2025-12-05 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06143v1)

- **Physics-Informed Neural Koopman Machine for Interpretable Longitudinal Personalized Alzheimer's Disease Forecasting**
  - 📅 2025-12-05 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06134v1)
...
- **Modular connectivity in neural networks emerges from Poisson noise-motivated regularisation, and promotes robustness and compositional generalisation**
  - 📅 2025-12-05 | 🏷️ `cs.LG, cs.NE, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.13707v1)

- **Toward Patch Robustness Certification and Detection for Deep Learning Systems Beyond Consistent Samples**
  - 📅 2025-12-05 | 🏷️ `cs.SE, cs.AI, cs.CR`
  - [Read Paper](https://arxiv.org/abs/2512.06123v1)

- **Hardware Software Optimizations for Fast Model Recovery on Reconfigurable Architectures**
  - 📅 2025-12-05 | 🏷️ `cs.AR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06113v1)

- **WAM-Flow: Parallel Coarse-to-Fine Motion Planning via Discrete Flow Matching for Autonomous Driving**
  - 📅 2025-12-05 | 🏷️ `cs.RO, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06112v2)

- **A Prescriptive Framework for Determining Optimal Days for Short-Term Traffic Counts**
  - 📅 2025-12-05 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06111v1)
...
- **SpectraIrisPAD: Leveraging Vision Foundation Models for Spectrally Conditioned Multispectral Iris Presentation Attack Detection**
  - 📅 2025-12-05 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06103v1)

- **JaxWildfire: A GPU-Accelerated Wildfire Simulator for Reinforcement Learning**
  - 📅 2025-12-05 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06102v1)

- **Empathy by Design: Aligning Large Language Models for Healthcare Dialogue**
  - 📅 2025-12-05 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06097v1)

- **BeLLA: End-to-End Birds Eye View Large Language Assistant for Autonomous Driving**
  - 📅 2025-12-05 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06096v1)

- **Shoot-Bounce-3D: Single-Shot Occlusion-Aware 3D from Lidar by Decomposing Two-Bounce Light**
  - 📅 2025-12-05 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06080v1)

- **Enhancing Retrieval-Augmented Generation with Entity Linking for Educational Platforms**
  - 📅 2025-12-05 | 🏷️ `cs.IR, cs.AI, cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05967v1)

- **EditThinker: Unlocking Iterative Reasoning for Any Image Editor**
  - 📅 2025-12-05 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05965v1)

- **Training-Time Action Conditioning for Efficient Real-Time Chunking**
  - 📅 2025-12-05 | 🏷️ `cs.RO, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05964v2)

- **EgoEdit: Dataset, Real-Time Streaming Model, and Benchmark for Egocentric Video Editing**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06065v1)

- **Whatever Remains Must Be True: Filtering Drives Reasoning in LLMs, Shaping Diversity**
  - 📅 2025-12-05 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05962v1)

- **AQUA-Net: Adaptive Frequency Fusion and Illumination Aware Network for Underwater Image Enhancement**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05960v1)

- **M4-RAG: A Massive-Scale Multilingual Multi-Cultural Multimodal RAG**
  - 📅 2025-12-05 | 🏷️ `cs.CL, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05959v1)

- **MaxShapley: Towards Incentive-compatible Generative Search with Fair Context Attribution**
  - 📅 2025-12-05 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05958v1)

- **Consequences of Kernel Regularity for Bandit Optimization**
  - 📅 2025-12-05 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05957v1)

- **When Privacy Isn't Synthetic: Hidden Data Leakage in Generative AI Models**
  - 📅 2025-12-05 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06062v1)

- **SIMPACT: Simulation-Enabled Action Planning using Vision-Language Models**
  - 📅 2025-12-05 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05955v1)

- **SymPyBench: A Dynamic Benchmark for Scientific Reasoning with Executable Python Code**
  - 📅 2025-12-05 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05954v1)

- **Trusted AI Agents in the Cloud**
  - 📅 2025-12-05 | 🏷️ `cs.CR, cs.AI, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.05951v2)

- **Impugan: Learning Conditional Generative Models for Robust Data Imputation**
  - 📅 2025-12-05 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05950v1)

- **Developing synthetic microdata through machine learning for firm-level business surveys**
  - 📅 2025-12-05 | 🏷️ `cs.LG, stat.AP, stat.ME`
  - [Read Paper](https://arxiv.org/abs/2512.05948v2)

- **Variational Quantum Rainbow Deep Q-Network for Optimizing Resource Allocation Problem**
  - 📅 2025-12-05 | 🏷️ `cs.AI, cs.ET, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.05946v1)

- **TRACE: A Framework for Analyzing and Enhancing Stepwise Reasoning in Vision-Language Models**
  - 📅 2025-12-05 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05943v3)

- **Zoom in, Click out: Unlocking and Evaluating the Potential of Zooming for GUI Grounding**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.05941v1)

- **Designing an Optimal Sensor Network via Minimizing Information Loss**
  - 📅 2025-12-05 | 🏷️ `stat.ME, cs.LG, stat.CO, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.05940v1)

- **Measuring the Effect of Background on Classification and Feature Importance in Deep Learning for AV Perception**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.AI, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.05937v1)

- **Synset Signset Germany: a Synthetic Dataset for German Traffic Sign Recognition**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.05936v1)

- **Physically-Based Simulation of Automotive LiDAR**
  - 📅 2025-12-05 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05932v1)

- **On the Bayes Inconsistency of Disagreement Discrepancy Surrogates**
  - 📅 2025-12-05 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.05931v1)

- **PRiSM: An Agentic Multimodal Benchmark for Scientific Reasoning via Python-Grounded Evaluation**
  - 📅 2025-12-05 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05930v1)

- **A Comparative Study on Synthetic Facial Data Generation Techniques for Face Recognition**
  - 📅 2025-12-05 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05928v1)

- **World Models That Know When They Don't Know: Controllable Video Generation with Calibrated Uncertainty**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.AI, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.05927v1)

- **BalLOT: Balanced $k$-means clustering with optimal transport**
  - 📅 2025-12-05 | 🏷️ `stat.ML, cs.DS, cs.IT, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05926v1)

- **To Err Is Human: Systematic Quantification of Errors in Published AI Papers via LLM Analysis**
  - 📅 2025-12-05 | 🏷️ `cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.05925v1)

- **LPD: Learnable Prototypes with Diversity Regularization for Weakly Supervised Histopathology Segmentation**
  - 📅 2025-12-05 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05922v1)

- **NICE: Neural Implicit Craniofacial Model for Orthognathic Surgery Prediction**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05920v1)

- **A Residual Variance Matching Recursive Least Squares Filter for Real-time UAV Terrain Following**
  - 📅 2025-12-05 | 🏷️ `cs.RO, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.05918v1)

- **Reinforcement Learning Integrated Agentic RAG for Software Test Cases Authoring**
  - 📅 2025-12-05 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06060v1)

- **KQ-SVD: Compressing the KV Cache with Provable Guarantees on Attention Fidelity**
  - 📅 2025-12-05 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05916v1)

- **LDLT $\mathcal{L}$-Lipschitz Network: Generalized Deep End-To-End Lipschitz Network Construction**
  - 📅 2025-12-05 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05915v1)
...
- **Fast and Robust Diffusion Posterior Sampling for MR Image Reconstruction Using the Preconditioned Unadjusted Langevin Algorithm**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05791v1)

- **Learnability Window in Gated Recurrent Neural Networks**
  - 📅 2025-12-05 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05790v2)

- **On the Dangers of Bootstrapping Generation for Continual Learning and Beyond**
  - 📅 2025-12-05 | 🏷️ `cs.LG, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11867v1)

- **Phase transitions reveal hierarchical structure in deep neural networks**
  - 📅 2025-12-05 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11866v1)

- **Curvature-Regularized Variational Autoencoder for 3D Scene Reconstruction from Sparse Depth**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05783v1)

- **Explainable Adversarial-Robust Vision-Language-Action Model for Robotic Manipulation**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.AI, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.11865v1)

- **Active Video Perception: Iterative Evidence Seeking for Agentic Long Video Understanding**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.05774v1)

- **The Missing Layer of AGI: From Pattern Alchemy to Coordination Physics**
  - 📅 2025-12-05 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05765v1)

- **Towards agent-based-model informed neural networks**
  - 📅 2025-12-05 | 🏷️ `cs.LG, cs.SI`
  - [Read Paper](https://arxiv.org/abs/2512.05764v2)

- **FNOPT: Resolution-Agnostic, Self-Supervised Cloth Simulation using Meta-Optimization with Fourier Neural Operators**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.GR`
  - [Read Paper](https://arxiv.org/abs/2512.05762v1)

- **Evolutionary System 2 Reasoning: An Empirical Proof**
  - 📅 2025-12-05 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05760v1)

- **Label-Efficient Point Cloud Segmentation with Active Learning**
  - 📅 2025-12-05 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.05759v1)

- **USV: Unified Sparsification for Accelerating Video Diffusion Models**
  - 📅 2025-12-05 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05754v1)

- **A Fast Anti-Jamming Cognitive Radar Deployment Algorithm Based on Reinforcement Learning**
  - 📅 2025-12-05 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05753v1)

- **Capturing Classic Authorial Style in Long-Form Story Generation with GRPO Fine-Tuning**
  - 📅 2025-12-05 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.05747v1)

- **HQ-DM: Single Hadamard Transformation-Based Quantization-Aware Training for Low-Bit Diffusion Models**
  - 📅 2025-12-05 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05746v2)
...
- **Robustness Test for AI Forecasting of Hurricane Florence Using FourCastNetv2 and Random Perturbations of the Initial Condition**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI, stat.ML, stat.OT`
  - [Read Paper](https://arxiv.org/abs/2512.05323v1)

- **Enhancing Deep Deterministic Policy Gradients on Continuous Control Tasks with Decoupled Prioritized Experience Replay**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05320v1)

- **Physics-Guided Deepfake Detection for Voice Authentication Systems**
  - 📅 2025-12-04 | 🏷️ `cs.SD, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06040v1)

- **To Think or Not to Think: The Hidden Cost of Meta-Training with Excessive CoT Examples**
  - 📅 2025-12-04 | 🏷️ `cs.CL, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05318v1)

- **WhatsCode: Large-Scale GenAI Deployment for Developer Efficiency at WhatsApp**
  - 📅 2025-12-04 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05314v1)
...
- **The Erosion of LLM Signatures: Can We Still Distinguish Human and LLM-Generated Scientific Ideas After Iterative Paraphrasing?**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05311v1)
...
- **Uncertainty Quantification for Scientific Machine Learning using Sparse Variational Gaussian Process Kolmogorov-Arnold Networks (SVGP KAN)**
  - 📅 2025-12-04 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.05306v2)

- **ARCAS: An Augmented Reality Collision Avoidance System with SLAM-Based Tracking for Enhancing VRU Safety**
  - 📅 2025-12-04 | 🏷️ `cs.AR, cs.CV, cs.ET, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.05299v1)

- **CFO: Learning Continuous-Time PDE Dynamics via Flow-Matched Neural Operators**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05297v1)
...
- **Bridging Interpretability and Optimization: Provably Attribution-Weighted Actor-Critic in Reproducing Kernel Hilbert Spaces**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05291v1)

- **Beyond Detection: A Comprehensive Benchmark and Study on Representation Learning for Fine-Grained Webshell Family Classification**
  - 📅 2025-12-04 | 🏷️ `cs.CR, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05288v1)
...
- **DMAGT: Unveiling miRNA-Drug Associations by Integrating SMILES and RNA Sequence Structures through Graph Transformer Models**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05287v1)

- **Developmental Symmetry-Loss: A Free-Energy Perspective on Brain-Inspired Invariance Learning**
  - 📅 2025-12-04 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10984v2)

- **From Segments to Scenes: Temporal Understanding in Autonomous Driving via Vision-Language Model**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05277v1)

- **Inferring Compositional 4D Scenes without Ever Seeing One**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05272v1)

- **Robust forecast aggregation via additional queries**
  - 📅 2025-12-04 | 🏷️ `cs.GT, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05271v1)

- **XR-DT: Extended Reality-Enhanced Digital Twin for Agentic Mobile Robots**
  - 📅 2025-12-04 | 🏷️ `cs.RO, cs.AI, cs.HC, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.05270v1)

- **CARD: Correlation Aware Restoration with Diffusion**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05268v1)

- **Uncertainty-Aware Data-Efficient AI: An Information-Theoretic Perspective**
  - 📅 2025-12-04 | 🏷️ `cs.IT, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05267v1)

- **Age-Inclusive 3D Human Mesh Recovery for Action-Preserving Data Anonymization**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05259v1)

- **Resolving Zadehs Paradox Axiomatic Possibility Theory as a Foundation for Reliable Artificial Intelligence**
  - 📅 2025-12-04 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05257v1)

- **Enhancing Clinical Note Generation with ICD-10, Clinical Ontology Knowledge Graphs, and Chain-of-Thought Prompting Using GPT-4**
  - 📅 2025-12-04 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.05256v1)

- **When unlearning is free: leveraging low influence points to reduce computational costs**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05254v1)
...
- **Mitigating the Antigenic Data Bottleneck: Semi-supervised Learning with Protein Language Models for Influenza A Surveillance**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05222v1)
...
- **Explainable AI for Smart Greenhouse Control: Interpretability of Temporal Fusion Transformer in the Internet of Robotic Things**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.11852v1)

- **Rethinking Tokenization for Clinical Time Series: When Less is More**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05217v1)

- **Coefficient of Variation Masking: A Volatility-Aware Strategy for EHR Foundation Models**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05216v1)

- **On the Computability of Artificial General Intelligence**
  - 📅 2025-12-04 | 🏷️ `cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.05212v1)

- **DEAR: Dataset for Evaluating the Aesthetics of Rendering**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05209v2)

- **Hierarchical Reinforcement Learning for the Dynamic VNE with Alternatives Problem**
  - 📅 2025-12-04 | 🏷️ `cs.NI, cs.LG, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.05207v1)

- **Your Latent Mask is Wrong: Pixel-Equivalent Latent Compositing for Diffusion Models**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.GR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05198v1)

- **The Universal Weight Subspace Hypothesis**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05117v2)

- **Light-X: Generative 4D Video Rendering with Camera and Illumination Control**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05115v2)

- **Value Gradient Guidance for Flow Matching Alignment**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05116v1)

- **Deep infant brain segmentation from multi-contrast MRI**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05114v1)

- **Splannequin: Freezing Monocular Mannequin-Challenge Footage with Dual-Detection Splatting**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05113v2)

- **DraCo: Draft as CoT for Text-to-Image Preview and Rare Concept Generation**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.AI, cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05112v1)

- **ARM-Thinker: Reinforcing Multimodal Generative Reward Models with Agentic Tool Use and Visual Reasoning**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05111v1)

- **ShadowDraw: From Any Object to Shadow-Drawing Compositional Art**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.AI, cs.GR`
  - [Read Paper](https://arxiv.org/abs/2512.05110v1)

- **NeuralRemaster: Phase-Preserving Diffusion for Structure-Aligned Generation**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.GR, cs.LG, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.05106v2)

- **Semantic Soft Bootstrapping: Long Context Reasoning in LLMs without Reinforcement Learning**
  - 📅 2025-12-04 | 🏷️ `cs.CL, cs.AI, cs.IT, cs.LG`
...
- **EvoIR: Towards All-in-One Image Restoration via Evolutionary Frequency Modulation**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05104v2)

- **TV2TV: A Unified Framework for Interleaved Language and Video Generation**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI, cs.CL, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05103v2)

- **Structured Document Translation via Format Reinforcement Learning**
  - 📅 2025-12-04 | 🏷️ `cs.CL, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05100v1)

- **SA-IQA: Redefining Image Quality Assessment for Spatial Aesthetics with Multi-Dimensional Rewards**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05098v1)

- **From Generated Human Videos to Physically Plausible Robot Trajectories**
  - 📅 2025-12-04 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05094v2)

- **Foundations of Diffusion Models in General State Spaces: A Self-Contained Introduction**
  - 📅 2025-12-04 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05092v1)

- **Visual Reasoning Tracer: Object-Level Grounded Reasoning Benchmark**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05091v1)

- **The Geometry of Intelligence: Deterministic Functional Topology as a Foundation for Real-World Perception**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05089v2)

- **Gradient Descent with Provably Tuned Learning-rate Schedules**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05084v1)

- **Deep Forcing: Training-Free Long Video Generation with Deep Sink and Participative Compression**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05081v1)
...
- **Object Reconstruction under Occlusion with Generative Priors and Contact-induced Constraints**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.05079v1)

- **BulletTime: Decoupled Control of Time and Camera Pose for Video Generation**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05076v1)

- **David vs. Goliath: Can Small Models Win Big with Agentic AI in Hardware Design?**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI, cs.AR, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.05073v1)

- **Control Consistency Losses for Diffusion Bridges**
  - 📅 2025-12-04 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05070v1)

- **Hybrid Quantum-Classical Autoencoders for Unsupervised Network Intrusion Detection**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.CR`
  - [Read Paper](https://arxiv.org/abs/2512.05069v1)

- **Fine-Tuning BERT for Domain-Specific Question Answering: Toward Educational NLP Resources at University Scale**
  - 📅 2025-12-04 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05179v1)

- **Multi-LLM Collaboration for Medication Recommendation**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.05066v1)

- **4DLangVGGT: 4D Language-Visual Geometry Grounded Transformer**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05060v1)

- **Meta-Learning for Quantum Optimization via Quantum Sequence Model**
  - 📅 2025-12-04 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05058v1)

- **QKAN-LSTM: Quantum-inspired Kolmogorov-Arnold Long Short-term Memory**
  - 📅 2025-12-04 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05049v1)

- **Joint 3D Geometry Reconstruction and Motion Generation for 4D Synthesis from a Single Image**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05044v1)

- **Semantic-Guided Two-Stage GAN for Face Inpainting with Hybrid Perceptual Encoding**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05039v1)

- **SuperActivators: Only the Tail of the Distribution Contains Reliable Concept Signals**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05038v1)

- **Arbitrage: Efficient Reasoning via Advantage-Aware Speculation**
  - 📅 2025-12-04 | 🏷️ `cs.CL, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05033v2)

- **Dual-Path Region-Guided Attention Network for Ground Reaction Force and Moment Regression**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05030v1)

- **RAMEN: Resolution-Adjustable Multimodal Encoder for Earth Observation**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05025v1)

- **Model-Free Assessment of Simulator Fidelity via Quantile Curves**
  - 📅 2025-12-04 | 🏷️ `stat.ME, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05024v1)

- **HTR-ConvText: Leveraging Convolution and Textual Information for Handwritten Text Recognition**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05021v1)

- **Generative Neural Video Compression via Video Diffusion Prior**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05016v1)

- **Detecting Perspective Shifts in Multi-agent Systems**
  - 📅 2025-12-04 | 🏷️ `cs.AI, cs.MA, stat.ME`
  - [Read Paper](https://arxiv.org/abs/2512.05013v1)

- **Factuality and Transparency Are All RAG Needs! Self-Explaining Contrastive Evidence Re-ranking**
  - 📅 2025-12-04 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.05012v1)

- **Self-Supervised Learning for Transparent Object Depth Completion Using Depth from Non-Transparent Objects**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05006v1)

- **Towards A Cultural Intelligence and Values Inferences Quality Benchmark for Community Values and Common Knowledge**
  - 📅 2025-12-04 | 🏷️ `cs.SE, cs.AI, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.05176v1)

- **Reflection Removal through Efficient Adaptation of Diffusion Transformers**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05000v1)

- **A dynamic memory assignment strategy for dilation-based ICP algorithm on embedded GPUs**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04996v1)

- **KV Cache Recycling to Expand Usable Context Capacity in Low Parameter LLMs**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI, cs.NE`
  - [Read Paper](https://arxiv.org/abs/2512.11851v1)

- **Evolutionary Architecture Search through Grammar-Based Sequence Alignment**
  - 📅 2025-12-04 | 🏷️ `cs.NE, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04992v1)

- **Strategic Self-Improvement for Competitive Agents in AI Labour Markets**
  - 📅 2025-12-04 | 🏷️ `cs.MA, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04988v1)

- **Nex-N1: Agentic Models Trained via a Unified Ecosystem for Large-Scale Environment Construction**
  - 📅 2025-12-04 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.04987v1)

- **Towards a unified framework for guided diffusion models**
  - 📅 2025-12-04 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04985v1)

- **Semore: VLM-guided Enhanced Semantic Motion Representations for Visual Reinforcement Learning**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05172v1)

- **Aligned but Stereotypical? The Hidden Influence of System Prompts on Social Bias in LVLM-Based Text-to-Image Models**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04981v1)

- **Learning Causality for Longitudinal Data**
  - 📅 2025-12-04 | 🏷️ `stat.ML, cs.IT, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04980v1)

- **Efficient Generative Transformer Operators For Million-Point PDEs**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04974v1)

- **Stable Single-Pixel Contrastive Learning for Semantic and Geometric Tasks**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04970v1)

- **Rethinking the Use of Vision Transformers for AI-Generated Image Detection**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04969v1)

- **Balanced Few-Shot Episodic Learning for Accurate Retinal Disease Diagnosis**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04967v1)

- **Environment-Aware Channel Inference via Cross-Modal Flow: From Multimodal Sensing to Wireless Channels**
  - 📅 2025-12-04 | 🏷️ `cs.IT, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04966v1)

- **Advanced Unsupervised Learning: A Comprehensive Overview of Multi-View Clustering Techniques**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05169v1)

- **GeoPE:A Unified Geometric Positional Embedding for Structured Tensors**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04963v1)

- **The SAM2-to-SAM3 Gap in the Segment Anything Model Family: Why Prompt-Based Expertise Fails in Concept-Driven Image Segmentation**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06032v1)

- **Realizable Abstractions: Near-Optimal Hierarchical Reinforcement Learning**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04958v1)

- **LLMs Know More Than Words: A Genre Study with Syntax, Metaphor & Phonetics**
  - 📅 2025-12-04 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04957v1)

- **Amortized Inference of Multi-Modal Posteriors using Likelihood-Weighted Normalizing Flows**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04954v1)

- **FASTer: Toward Efficient Autoregressive Vision Language Action Modeling via Neural Action Tokenization**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.04952v2)

- **Multi-resolution Physics-Aware Recurrent Convolutional Neural Network for Complex Flows**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.06031v1)

- **CARL: Critical Action Focused Reinforcement Learning for Multi-Step Agent**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.04949v1)

- **Towards Adaptive Fusion of Multimodal Deep Networks for Human Action Recognition**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04943v1)

- **LiteVGGT: Boosting Vanilla VGGT via Geometry-aware Cached Token Merging**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04939v1)
...
- **OmniScaleSR: Unleashing Scale-Controlled Diffusion Prior for Faithful and Realistic Arbitrary-Scale Image Super-Resolution**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04699v1)

- **Continuous-time reinforcement learning for optimal switching over multiple regimes**
  - 📅 2025-12-04 | 🏷️ `cs.LG, q-fin.CP`
  - [Read Paper](https://arxiv.org/abs/2512.04697v1)

- **Provable FDR Control for Deep Feature Selection: Deep MLPs and Beyond**
  - 📅 2025-12-04 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04696v1)

- **TRINITY: An Evolved LLM Coordinator**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04695v1)

- **TimesNet-Gen: Deep Learning-based Site Specific Strong Motion Generation**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04694v1)

- **Towards Ethical Multi-Agent Systems of Large Language Models: A Mechanistic Interpretability Perspective**
  - 📅 2025-12-04 | 🏷️ `cs.AI, cs.CL, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.04691v1)
...
- **How to Tame Your LLM: Semantic Collapse in Continuous Systems**
  - 📅 2025-12-04 | 🏷️ `stat.ML, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05162v1)

- **Towards Cross-View Point Correspondence in Vision-Language Models**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04686v2)

- **Geschlechtsübergreifende Maskulina im Sprachgebrauch Eine korpusbasierte Untersuchung zu lexemspezifischen Unterschieden**
  - 📅 2025-12-04 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.04683v2)

- **Neural reconstruction of 3D ocean wave hydrodynamics from camera sensing**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.06024v1)

- **Generative AI for Self-Adaptive Systems: State of the Art and Research Roadmap**
  - 📅 2025-12-04 | 🏷️ `cs.SE, cs.AI, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.04680v1)

- **Reward Forcing: Efficient Streaming Video Generation with Rewarded Distribution Matching Distillation**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04678v1)

- **Live Avatar: Streaming Real-time Audio-Driven Avatar Generation with Infinite Length**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04677v2)

- **Topology Matters: Measuring Memory Leakage in Multi-Agent LLMs**
  - 📅 2025-12-04 | 🏷️ `cs.CR, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.04668v2)

- **Fermionic neural Gibbs states**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04663v1)

- **I2I-Bench: A Comprehensive Benchmark Suite for Image-to-Image Editing Models**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04660v1)
...
- **Norm-Governed Multi-Agent Decision-Making in Simulator-Coupled Environments:The Reinsurance Constrained Multi-Agent Simulation Process (R-CMASP)**
  - 📅 2025-12-04 | 🏷️ `cs.MA, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.09939v1)
...
- **Dataset creation for supervised deep learning-based analysis of microscopic images -- review of important considerations and recommendations**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04564v1)

- **COOPER: A Unified Model for Cooperative Perception and Reasoning in Spatial Intelligence**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04563v2)

- **LeMat-GenBench: A Unified Evaluation Framework for Crystal Generative Models**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04562v1)

- **Diffusion Fine-Tuning via Reparameterized Policy Gradient of the Soft Q-Function**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04559v1)

- **On the Limits of Test-Time Compute: Sequential Reward Filtering for Better Inference**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04558v1)

- **Efficient Spatially-Variant Convolution via Differentiable Sparse Kernel Complex**
  - 📅 2025-12-04 | 🏷️ `cs.GR, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04556v1)

- **ADAPT: Learning Task Mixtures for Budget-Constrained Instruction Tuning**
  - 📅 2025-12-04 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.04555v1)

- **Counterfeit Answers: Adversarial Forgery against OCR-Free Document Visual Question Answering**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04554v1)

- **RRPO: Robust Reward Policy Optimization for LLM-based Emotional TTS**
  - 📅 2025-12-04 | 🏷️ `cs.SD, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04552v1)

- **Multi-Loss Learning for Speech Emotion Recognition with Energy-Adaptive Mixup and Frame-Level Attention**
  - 📅 2025-12-04 | 🏷️ `cs.SD, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04551v1)

- **AdmTree: Compressing Lengthy Context with Adaptive Semantic Trees**
  - 📅 2025-12-04 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04550v1)
...
- **EvoEdit: Lifelong Free-Text Knowledge Editing through Latent Perturbation Augmentation and Knowledge-driven Parameter Fusion**
  - 📅 2025-12-04 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.04545v1)

- **Gaussian Entropy Fields: Driving Adaptive Sparsity in 3D Gaussian Optimization**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04542v1)

- **VideoMem: Enhancing Ultra-Long Video Understanding via Adaptive Memory Management**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04540v2)

- **X-Humanoid: Robotize Human Videos to Generate Humanoid Videos at Scale**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04537v1)

- **Detection of Intoxicated Individuals from Facial Video Sequences via a Recurrent Fusion Model**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04536v1)

- **Continuous-Time Homeostatic Dynamics for Reentrant Inference Models**
  - 📅 2025-12-04 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.05158v1)

- **GTM: Simulating the World of Tools for AI Agents**
  - 📅 2025-12-04 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04535v2)

- **Refaçade: Editing Object with Given Reference Texture**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04534v1)

- **PhyVLLM: Physics-Guided Video Language Model with Motion-Appearance Disentanglement**
  - 📅 2025-12-04 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04532v1)

- **Explainable Graph Representation Learning via Graph Pattern Analysis**
  - 📅 2025-12-04 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04530v1)

- **SlideGen: Collaborative Multimodal Agents for Scientific Slide Generation**
  - 📅 2025-12-04 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04529v2)

- **Auto3R: Automated 3D Reconstruction and Scanning via Data-driven Uncertainty Quantification**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04528v1)

- **Prototype-Based Semantic Consistency Alignment for Domain Adaptive Retrieval**
  - 📅 2025-12-04 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04524v2)

- **Identity Clue Refinement and Enhancement for Visible-Infrared Person Re-Identification**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04522v1)

- **WiFi-based Cross-Domain Gesture Recognition Using Attention Mechanism**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04521v1)

- **Boundary-Aware Test-Time Adaptation for Zero-Shot Medical Image Segmentation**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04520v1)

- **VideoSSM: Autoregressive Long Video Generation with Hybrid State-Space Memory**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04519v1)

- **UW-BioNLP at ChemoTimelines 2025: Thinking, Fine-Tuning, and Dictionary-Enhanced LLM Systems for Chemotherapy Timeline Extraction**
  - 📅 2025-12-04 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04518v1)

- **EgoLCD: Egocentric Video Generation with Long Context Diffusion**
  - 📅 2025-12-04 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04515v1)
...
- **A Conceptual Model for AI Adoption in Financial Decision-Making: Addressing the Unique Challenges of Small and Medium-Sized Enterprises**
  - 📅 2025-12-03 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04339v1)

- **One Detector Fits All: Robust and Adaptive Detection of Malicious Packages from PyPI to Enterprises**
  - 📅 2025-12-03 | 🏷️ `cs.CR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04338v1)

- **RGE-GCN: Recursive Gene Elimination with Graph Convolutional Networks for RNA-seq based Early Cancer Detection**
  - 📅 2025-12-03 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04333v2)

- **Data-regularized Reinforcement Learning for Diffusion Models at Scale**
  - 📅 2025-12-03 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04332v2)

- **Spiking Manifesto**
  - 📅 2025-12-03 | 🏷️ `cs.NE, cs.AI, cs.AR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11843v1)

- **Open Set Face Forgery Detection via Dual-Level Evidence Collection**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04331v1)

- **A Retrieval-Augmented Generation Approach to Extracting Algorithmic Logic from Neural Networks**
  - 📅 2025-12-03 | 🏷️ `cs.CV, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.04329v1)

- **DAComp: Benchmarking Data Agents across the Full Data Intelligence Lifecycle**
  - 📅 2025-12-03 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04324v1)

- **Bayes-DIC Net: Estimating Digital Image Correlation Uncertainty with Bayesian Neural Networks**
  - 📅 2025-12-03 | 🏷️ `cs.CV, cs.AI, cs.CE, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04323v1)

- **MANTRA: a Framework for Multi-stage Adaptive Noise TReAtment During Training**
  - 📅 2025-12-03 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04319v1)

- **SyncTrack4D: Cross-Video Motion Alignment and Video Synchronization for Multi-Video 4D Gaussian Splatting**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04315v1)

- **DisentangleFormer: Spatial-Channel Decoupling for Multi-Channel Vision**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04314v1)

- **Mind-to-Face: Neural-Driven Photorealistic Avatar Synthesis via EEG Decoding**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04313v1)

- **Real-time Cricket Sorting By Sex**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04311v1)

- **RNNs perform task computations by dynamically warping neural representations**
  - 📅 2025-12-03 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04310v1)

- **Text-Only Training for Image Captioning with Retrieval Augmentation and Modality Gap Correction**
  - 📅 2025-12-03 | 🏷️ `cs.CV, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.04309v1)

- **Evaluating Long-Context Reasoning in LLM-Based WebAgents**
  - 📅 2025-12-03 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04307v1)

- **How (Mis)calibrated is Your Federated CLIP and What To Do About It?**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04305v1)

- **Gamma-from-Mono: Road-Relative, Metric, Self-Supervised Monocular Geometry for Vehicular Applications**
  - 📅 2025-12-03 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04303v1)

- **Towards better dense rewards in Reinforcement Learning Applications**
  - 📅 2025-12-03 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04302v1)

- **When do spectral gradient updates help in deep learning?**
  - 📅 2025-12-03 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.04299v1)
...
- **Hey GPT-OSS, Looks Like You Got It -- Now Walk Me Through It! An Assessment of the Reasoning Language Models Chain of Thought Mechanism for Digital Forensics**
  - 📅 2025-12-03 | 🏷️ `cs.CR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04254v1)

- **Fine-Tuning ChemBERTa for Predicting Inhibitory Activity Against TDP1 Using Deep Learning**
  - 📅 2025-12-03 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04252v1)

- **MVRoom: Controllable 3D Indoor Scene Generation with Multi-View Diffusion Models**
  - 📅 2025-12-03 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04248v1)

- **Toward Virtuous Reinforcement Learning**
  - 📅 2025-12-03 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04246v1)

- **6 Fingers, 1 Kidney: Natural Adversarial Medical Images Reveal Critical Weaknesses of Vision-Language Models**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04238v1)

- **CRAFT-E: A Neuro-Symbolic Framework for Embodied Affordance Grounding**
  - 📅 2025-12-03 | 🏷️ `cs.RO, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04231v1)
...
- **Addressing Logical Fallacies In Scientific Reasoning From Large Language Models: Towards a Dual-Inference Training Framework**
  - 📅 2025-12-03 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04228v1)

- **Meta-Continual Mobility Forecasting for Proactive Handover Prediction**
  - 📅 2025-12-03 | 🏷️ `cs.LG, cs.NI`
  - [Read Paper](https://arxiv.org/abs/2512.11841v1)

- **Educational Cone Model in Embedding Vector Spaces**
  - 📅 2025-12-03 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04227v1)

- **ActVAE: Modelling human activity schedules with a deep conditional generative approach**
  - 📅 2025-12-03 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04223v1)

- **ReasonX: MLLM-Guided Intrinsic Image Decomposition**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04222v1)

- **MoReGen: Multi-Agent Motion-Reasoning Engine for Code-based Text-to-Video Synthesis**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04221v2)

- **On GRPO Collapse in Search-R1: The Lazy Likelihood-Displacement Death Spiral**
  - 📅 2025-12-03 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.04220v1)

- **Generalized Event Partonomy Inference with Structured Hierarchical Predictive Learning**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04219v1)

- **Look Around and Pay Attention: Multi-camera Point Tracking Reimagined with Transformers**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04213v1)

- **Balancing Safety and Helpfulness in Healthcare AI Assistants through Iterative Preference Alignment**
  - 📅 2025-12-03 | 🏷️ `cs.AI, cs.CL, cs.CY`
  - [Read Paper](https://arxiv.org/abs/2512.04210v1)

- **Orchestrator Multi-Agent Clinical Decision Support System for Secondary Headache Diagnosis in Primary Care**
  - 📅 2025-12-03 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04207v2)

- **Machine Phenomenology: A Simple Equation Classifying Fast Radio Bursts**
  - 📅 2025-12-03 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04204v1)

- **Network of Theseus (like the ship)**
  - 📅 2025-12-03 | 🏷️ `cs.LG, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.04198v1)

- **BEP: A Binary Error Propagation Algorithm for Binary Neural Networks Training**
  - 📅 2025-12-03 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04189v1)

- **OnSight Pathology: A real-time platform-agnostic computational pathology companion for histopathology**
  - 📅 2025-12-03 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04187v1)

- **Beyond Flicker: Detecting Kinematic Inconsistencies for Generalizable Deepfake Video Detection**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04175v1)

- **Mitigating the Curse of Detail: Scaling Arguments for Feature Learning and Sample Complexity**
  - 📅 2025-12-03 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.04165v3)

- **Enhancing next token prediction based pre-training for jet foundation models**
  - 📅 2025-12-03 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04149v1)

- **Unique Lives, Shared World: Learning from Single-Life Videos**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04085v1)

- **SimFlow: Simplified and End-to-End Training of Latent Normalizing Flows**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04084v1)

- **PosterCopilot: Toward Layout Reasoning and Controllable Editing for Professional Graphic Design**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04082v1)

- **RippleBench: Capturing Ripple Effects Using Existing Knowledge Repositories**
  - 📅 2025-12-03 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04144v1)

- **Radiance Meshes for Volumetric Reconstruction**
  - 📅 2025-12-03 | 🏷️ `cs.GR, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.04076v1)

- **SkillFactory: Self-Distillation For Learning Cognitive Behaviors**
  - 📅 2025-12-03 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04072v1)

- **SpaceTools: Tool-Augmented Spatial Reasoning via Double Interactive RL**
  - 📅 2025-12-03 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.04069v1)

- **Learning Steerable Clarification Policies with Collaborative Self-play**
  - 📅 2025-12-03 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04068v1)

- **Fare Comparison App of Uber, Ola and Rapido**
  - 📅 2025-12-03 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04065v1)

- **Eval Factsheets: A Structured Framework for Documenting AI Evaluations**
  - 📅 2025-12-03 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04062v1)

- **Closing the problem of which causal structures of up to six total nodes have a classical-quantum gap**
  - 📅 2025-12-03 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04058v1)

- **Amortized Causal Discovery with Prior-Fitted Networks**
  - 📅 2025-12-03 | 🏷️ `cs.LG, stat.ME, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.11840v1)

- **Convergence for Discrete Parameter Update Schemes**
  - 📅 2025-12-03 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04051v2)

- **Stable Signer: Hierarchical Sign Language Generative Model**
  - 📅 2025-12-03 | 🏷️ `cs.CV, cs.CL, cs.CY`
...
- **PULSE: A Unified Multi-Task Architecture for Cardiac Segmentation, Diagnosis, and Few-Shot Cross-Modality Clinical Adaptation**
  - 📅 2025-12-03 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03848v1)

- **DVPO: Distributional Value Modeling-based Policy Optimization for LLM Post-Training**
  - 📅 2025-12-03 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03847v1)

- **CoDA: From Text-to-Image Diffusion Models to Training-Free Dataset Distillation**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03844v1)
...
- **Unlocking the Invisible Urban Traffic Dynamics under Extreme Weather: A New Physics-Constrained Hamiltonian Learning Algorithm**
  - 📅 2025-12-03 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03744v1)

- **Cross-embodied Co-design for Dexterous Hands**
  - 📅 2025-12-03 | 🏷️ `cs.RO, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03743v1)

- **AR-Med: Automated Relevance Enhancement in Medical Search via LLM-Driven Information Augmentation**
  - 📅 2025-12-03 | 🏷️ `cs.CL, cs.IR`
  - [Read Paper](https://arxiv.org/abs/2512.03737v1)
...
- **Hybrid twinning using PBDW and DeepONet for the effective state estimation and prediction on partially known systems**
  - 📅 2025-12-03 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.11834v1)

- **Out-of-the-box: Black-box Causal Attacks on Object Detectors**
  - 📅 2025-12-03 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03730v1)
...
- **FeatureLens: A Highly Generalizable and Interpretable Framework for Detecting Adversarial Examples Based on Image Features**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03625v1)
...
- **ReCamDriving: LiDAR-Free Camera-Controlled Novel Trajectory Video Generation**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03621v1)

- **SELF: A Robust Singular Value and Eigenvalue Approach for LLM Fingerprinting**
  - 📅 2025-12-03 | 🏷️ `cs.CR, cs.AI, cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03620v1)

- **LAMP: Language-Assisted Motion Planning for Controllable Video Generation**
  - 📅 2025-12-03 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03619v2)

- **Soft Decision Tree classifier: explainable and extendable PyTorch implementation**
  - 📅 2025-12-03 | 🏷️ `cs.LG, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.11833v1)

- **CoGraM: Context-sensitive granular optimization method with rollback for robust model fusion**
  - 📅 2025-12-03 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03610v2)

- **KVNAND: Efficient On-Device Large Language Model Inference Using DRAM-Free In-Flash Computing**
  - 📅 2025-12-03 | 🏷️ `cs.AR, cs.AI, cs.ET`
  - [Read Paper](https://arxiv.org/abs/2512.03608v1)
...
- **DeepRule: An Integrated Framework for Automated Business Rule Generation via Deep Predictive Modeling and Hybrid Search Optimization**
  - 📅 2025-12-03 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03607v1)
...
- **Modeling Topics and Sociolinguistic Variation in Code-Switched Discourse: Insights from Spanish-English and Spanish-Guaraní**
  - 📅 2025-12-03 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.03334v1)

- **Sketch Tomography: Hybridizing Classical Shadow and Matrix Product State**
  - 📅 2025-12-03 | 🏷️ `stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.03333v1)

- **When does Gaussian equivalence fail and how to fix it: Non-universal behavior of random features with quadratic scaling**
  - 📅 2025-12-03 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.03325v1)

- **Cache What Lasts: Token Retention for Memory-Bounded KV Cache in LLMs**
  - 📅 2025-12-03 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03324v1)

- **SSLfmm: An R Package for Semi-Supervised Learning with a Mixed-Missingness Mechanism in Finite Mixture Models**
  - 📅 2025-12-03 | 🏷️ `stat.CO, stat.ME, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.03322v2)

- **Evaluating Generalization Capabilities of LLM-Based Agents in Mixed-Motive Scenarios Using Concordia**
  - 📅 2025-12-03 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03318v1)

- **NavMapFusion: Diffusion-based Fusion of Navigation Maps for Online Vectorized HD Map Construction**
  - 📅 2025-12-03 | 🏷️ `cs.CV, cs.AI, cs.LG, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.03317v1)

- **CrowdLLM: Building LLM-Based Digital Populations Augmented with Generative Models**
  - 📅 2025-12-02 | 🏷️ `cs.MA, cs.LG, stat.ME, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.07890v1)

- **Unlocking hidden biomolecular conformational landscapes in diffusion models at inference time**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03312v1)

- **Randomized Masked Finetuning: An Efficient Way to Mitigate Memorization of PIIs in LLMs**
  - 📅 2025-12-02 | 🏷️ `cs.CL, cs.CR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03310v1)

- **Retrofitting Earth System Models with Cadence-Limited Neural Operator Updates**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03309v1)

- **Robust Tabular Foundation Models**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03307v1)

- **HydroDCM: Hydrological Domain-Conditioned Modulation for Cross-Reservoir Inflow Prediction**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03300v1)
...
- **Adaptive Regime-Switching Forecasts with Distribution-Free Uncertainty: Deep Switching State-Space Models Meet Conformal Prediction**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03298v1)

- **Associating Healthcare Teamwork with Patient Outcomes for Predictive Analysis**
  - 📅 2025-12-02 | 🏷️ `cs.SI, cs.CY, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03296v1)

- **Prior preferences in active inference agents: soft, hard, and goal shaping**
  - 📅 2025-12-02 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03293v1)

- **ASPEN: An Adaptive Spectral Physics-Enabled Network for Ginzburg-Landau Dynamics**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03290v2)

- **Multi-Frequency Federated Learning for Human Activity Recognition Using Head-Worn Sensors**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.DC`
  - [Read Paper](https://arxiv.org/abs/2512.03287v1)

- **SpatialReasoner: Active Perception for Large-Scale 3D Scene Understanding**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03284v1)

- **BlendedNet++: A Large-Scale Blended Wing Body Aerodynamics Dataset and Benchmark**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03280v1)

- **Thucy: An LLM-based Multi-Agent System for Claim Verification across Relational Databases**
  - 📅 2025-12-02 | 🏷️ `cs.DB, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03278v1)

- **Too Late to Recall: Explaining the Two-Hop Problem in Multimodal Knowledge Retrieval**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03276v1)

- **When Do Symbolic Solvers Enhance Reasoning in Large Language Models?**
  - 📅 2025-12-02 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03272v1)

- **Is Vibe Coding Safe? Benchmarking Vulnerability of Agent-Generated Code in Real-World Tasks**
  - 📅 2025-12-02 | 🏷️ `cs.SE, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.03262v1)

- **PyroFocus: A Deep Learning Approach to Real-Time Wildfire Detection in Multispectral Remote Sensing Imagery**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03257v1)

- **Agent-Based Modular Learning for Multimodal Emotion Recognition in Human-Agent Systems**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI, cs.HC, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.10975v1)

- **Learning Network Sheaves for AI-native Semantic Communication**
  - 📅 2025-12-02 | 🏷️ `cs.MA, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03248v1)

- **PixPerfect: Seamless Latent Diffusion Local Editing with Discriminative Pixel-Space Refinement**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03247v1)

- **2-Shots in the Dark: Low-Light Denoising with Minimal Data Acquisition**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03245v1)

- **SPARK: Stepwise Process-Aware Rewards for Reference-Free Reinforcement Learning**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.03244v1)

- **Novelty detection on path space**
  - 📅 2025-12-02 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03243v1)

- **How to DP-fy Your Data: A Practical Guide to Generating Synthetic Data With Differential Privacy**
  - 📅 2025-12-02 | 🏷️ `cs.CR, cs.AI, cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.03238v1)

- **LLM-Guided Material Inference for 3D Point Clouds**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.GR`
  - [Read Paper](https://arxiv.org/abs/2512.03237v1)

- **Iterative Tilting for Diffusion Fine-Tuning**
  - 📅 2025-12-02 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03234v1)

- **Object Counting with GPT-4o and GPT-5: A Comparative Study**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03233v1)

- **Convergence of a class of gradient-free optimisation schemes when the objective function is noisy, irregular, or both**
  - 📅 2025-12-02 | 🏷️ `stat.CO, cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.03225v1)

- **ASCIIBench: Evaluating Language-Model-Based Understanding of Visually-Oriented Text**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04125v1)

- **Self-Improving VLM Judges Without Human Annotations**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.05145v1)

- **Perch 2.0 transfers 'whale' to underwater tasks**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03219v1)

- **Kaleidoscopic Scintillation Event Imaging**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03216v1)

- **Identifying attributions of causality in political text**
  - 📅 2025-12-02 | 🏷️ `cs.CL, cs.CY`
  - [Read Paper](https://arxiv.org/abs/2512.03214v1)

- **A Multi-Agent, Policy-Gradient approach to Network Routing**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.NI`
  - [Read Paper](https://arxiv.org/abs/2512.03211v1)

- **Flux4D: Flow-based Unsupervised 4D Reconstruction**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.LG, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.03210v1)

- **Uncertainty Quantification for Large Language Model Reward Learning under Heterogeneous Human Feedback**
  - 📅 2025-12-02 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03208v1)

- **Scaling Internal-State Policy-Gradient Methods for POMDPs**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03204v1)

- **Does Head Pose Correction Improve Biometric Facial Recognition?**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03199v1)

- **InvertiTune: High-Quality Data Synthesis for Cost-Effective Single-Shot Text-to-Knowledge Graph Generation**
  - 📅 2025-12-02 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03197v1)

- **Ultra-Strong Gradient Diffusion MRI with Self-Supervised Learning for Prostate Cancer Characterization**
  - 📅 2025-12-02 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03196v1)

- **Enhancing Job Matching: Occupation, Skill and Qualification Linking with the ESCO and EQF taxonomies**
  - 📅 2025-12-02 | 🏷️ `cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03195v1)

- **GRAND: Guidance, Rebalancing, and Assignment for Networked Dispatch in Multi-Agent Path Finding**
  - 📅 2025-12-02 | 🏷️ `cs.RO, cs.LG, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.03194v1)

- **In Situ Quantum Analog Pulse Characterization via Structured Signal Processing**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03193v1)

- **Neighborhood density estimation using space-partitioning based hashing schemes**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03187v1)

- **Drainage: A Unifying Framework for Addressing Class Uncertainty**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03182v1)

- **Plantain: Plan-Answer Interleaved Reasoning**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03176v1)

- **Culture Affordance Atlas: Reconciling Object Diversity Through Functional Mapping**
  - 📅 2025-12-02 | 🏷️ `cs.CY, cs.AI, cs.CL, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03173v1)

- **Multi-Agent Reinforcement Learning and Real-Time Decision-Making in Robotic Soccer for Virtual Environments**
  - 📅 2025-12-02 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03166v1)

- **Contrastive Deep Learning for Variant Detection in Wastewater Genomic Sequencing**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03158v1)

- **MagicQuillV2: Precise and Interactive Image Editing with Layered Visual Cues**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03046v1)

- **CAMEO: Correspondence-Attention Alignment for Multi-View Diffusion Models**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03045v1)

- **OneThinker: All-in-one Reasoning Model for Image and Video**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03043v2)

- **PPTArena: A Benchmark for Agentic PowerPoint Editing**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03042v2)

- **MultiShotMaster: A Controllable Multi-Shot Video Generation Framework**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03041v1)

- **Video4Spatial: Towards Visuospatial Intelligence with Context-Guided Video Generation**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03040v2)

- **Atomic Diffusion Models for Small Molecule Structure Elucidation from NMR Spectra**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03127v1)

- **ViSAudio: End-to-End Video-Driven Binaural Spatial Audio Generation**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03036v1)

- **Learning Physically Consistent Lagrangian Control Models Without Acceleration Measurements**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03035v1)

- **MAViD: A Multimodal Framework for Audio-Visual Dialogue Understanding and Generation**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03034v1)

- **Enhancing Automatic Speech Recognition Through Integrated Noise Detection Architecture**
  - 📅 2025-12-02 | 🏷️ `cs.SD, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08973v1)

- **SMP: Reusable Score-Matching Motion Priors for Physics-Based Character Control**
  - 📅 2025-12-02 | 🏷️ `cs.GR, cs.AI, cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.03028v2)

- **The Moral Consistency Pipeline: Continuous Ethical Evaluation for Large Language Models**
  - 📅 2025-12-02 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03026v1)

- **LORE: A Large Generative Model for Search Relevance**
  - 📅 2025-12-02 | 🏷️ `cs.IR, cs.AI, cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03025v2)

- **TokenPowerBench: Benchmarking the Power Consumption of LLM Inference**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI, cs.CY, cs.DC`
  - [Read Paper](https://arxiv.org/abs/2512.03024v1)

- **Unrolled Networks are Conditional Probability Flows in MRI Reconstruction**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03020v1)

- **Distribution-Calibrated Inference time compute for Thinking LLM-as-a-Judge**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03019v1)

- **Hierarchical Process Reward Models are Symbolic Vision Learners**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03126v1)

- **AutoBrep: Autoregressive B-Rep Generation with Unified Topology and Geometry**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03018v1)

- **Simple Agents Outperform Experts in Biomedical Imaging Workflow Optimization**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.06006v1)

- **Instant Video Models: Universal Adapters for Stabilizing Image-Based Networks**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03014v1)

- **In-Context Sync-LoRA for Portrait Video Editing**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.AI, cs.GR`
  - [Read Paper](https://arxiv.org/abs/2512.03013v1)

- **Mitigating Intra- and Inter-modal Forgetting in Continual Learning of Unified Multimodal Models**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03125v1)

- **SurfFill: Completion of LiDAR Point Clouds via Gaussian Surfel Splatting**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.GR, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.03010v1)

- **From Moderation to Mediation: Can LLMs Serve as Mediators in Online Flame Wars?**
  - 📅 2025-12-02 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03005v2)

- **DGGT: Feedforward 4D Reconstruction of Dynamic Driving Scenes using Unposed Images**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03004v1)

- **Invasive Context Engineering to Control Large Language Models**
  - 📅 2025-12-02 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03001v1)

- **DynamicVerse: A Physically-Aware Multimodal Framework for 4D World Modeling**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03000v2)

- **TEXTRIX: Latent Attribute Grid for Native Texture Generation and Beyond**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02993v1)

- **GraphFusion3D: Dynamic Graph Attention Convolution with Adaptive Cross-Modal Transformer for 3D Object Detection**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02991v1)

- **Fine-Tuned Large Language Models for Logical Translation: Reducing Hallucinations with Lang2Logic**
  - 📅 2025-12-02 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02987v1)

- **ProteinPNet: Prototypical Part Networks for Concept Learning in Spatial Proteomics**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02983v1)

- **U4D: Uncertainty-Aware 4D World Modeling from LiDAR Sequences**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.02982v1)

- **InEx: Hallucination Mitigation via Introspection and Cross-Modal Multi-Agent Collaboration**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02981v1)

- **Rethinking Generalized BCIs: Benchmarking 340,000+ Unique Algorithmic Configurations for EEG Mental Command Decoding**
  - 📅 2025-12-02 | 🏷️ `cs.AI, cs.HC, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02978v1)

- **Contextual Image Attack: How Visual Context Exposes Multimodal Safety Vulnerabilities**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.CL, cs.CR`
  - [Read Paper](https://arxiv.org/abs/2512.02973v1)

- **BEVDilation: LiDAR-Centric Multi-Modal Fusion for 3D Object Detection**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.02972v1)

- **Identification of Multivariate Measurement Error Models**
  - 📅 2025-12-02 | 🏷️ `stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.02970v1)

- **Flexible Gravitational-Wave Parameter Estimation with Transformers**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02968v1)

- **Pruning AMR: Efficient Visualization of Implicit Neural Representations via Weight Matrix Analysis**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02967v1)

- **Lumos: Let there be Language Model System Certification**
  - 📅 2025-12-02 | 🏷️ `cs.PL, cs.AI, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.02966v1)

- **A Lightweight Real-Time Low-Light Enhancement Network for Embedded Automotive Vision Systems**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02965v1)

- **Layout Anything: One Transformer for Universal Room Layout Estimation**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02952v1)

- **Representation of Inorganic Synthesis Reactions and Prediction: Graphical Framework and Datasets**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02947v1)

- **Benchmarking Scientific Understanding and Reasoning for Video Generation using VideoScience-Bench**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02942v1)

- **LoVoRA: Text-guided and Mask-free Video Object Removal and Addition with Learnable Object-aware Localization**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02933v2)

- **EGGS: Exchangeable 2D/3D Gaussian Splatting for Geometry-Appearance Balanced Novel View Synthesis**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02932v1)

- **When AI Takes the Couch: Psychometric Jailbreaks Reveal Internal Conflict in Frontier Models**
  - 📅 2025-12-02 | 🏷️ `cs.CY, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04124v2)

- **DiverseAR: Boosting Diversity in Bitwise Autoregressive Image Generation**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02931v1)

- **Fast Gaussian Process Approximations for Autocorrelated Data**
  - 📅 2025-12-02 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.02925v1)

- **AutoNeural: Co-Designing Vision-Language Models for NPU Inference**
  - 📅 2025-12-02 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02924v2)

- **Measuring Agents in Production**
  - 📅 2025-12-02 | 🏷️ `cs.CY, cs.AI, cs.LG, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.04123v1)

- **Learning Multimodal Embeddings for Traffic Accident Prediction and Causal Estimation**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.CV, cs.SI`
  - [Read Paper](https://arxiv.org/abs/2512.02920v1)

- **Martingale Score: An Unsupervised Metric for Bayesian Rationality in LLM Reasoning**
  - 📅 2025-12-02 | 🏷️ `cs.AI, cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02914v1)

- **Hypothesis Testing for Generalized Thurstone Models**
  - 📅 2025-12-02 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.02912v1)

- **In Silico Development of Psychometric Scales: Feasibility of Representative Population Data Simulation with LLMs**
  - 📅 2025-12-02 | 🏷️ `cs.HC, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02910v1)

- **MRD: Multi-resolution Retrieval-Detection Fusion for High-Resolution Image Understanding**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.AI, cs.MM`
  - [Read Paper](https://arxiv.org/abs/2512.02906v2)

- **Towards a fully differentiable digital twin for solar cells**
  - 📅 2025-12-02 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02904v1)

- **VLA Models Are More Generalizable Than You Think: Revisiting Physical and Spatial Modeling**
  - 📅 2025-12-02 | 🏷️ `cs.RO, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02902v1)

- **Fairy2i: Training Complex LLMs from Real LLMs with All Parameters in $\{\pm 1, \pm i\}$**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02901v2)

- **Glance: Accelerating Diffusion Models with 1 Sample**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02899v2)

- **Model-Based Diagnosis with Multiple Observations: A Unified Approach for C Software and Boolean Circuits**
  - 📅 2025-12-02 | 🏷️ `cs.SE, cs.AI, cs.LO, cs.SC`
  - [Read Paper](https://arxiv.org/abs/2512.02898v1)

- **Polar Perspectives: Evaluating 2-D LiDAR Projections for Robust Place Recognition with Visual Foundation Models**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.02897v1)

- **MindGPT-4ov: An Enhanced MLLM via a Multi-Stage Post-Training Paradigm**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02895v2)

- **Fast-Decoding Diffusion Language Models via Progress-Aware Confidence Schedules**
  - 📅 2025-12-02 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02892v1)

- **OptPO: Optimal Rollout Allocation for Test-time Policy Optimization**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02882v1)

- **The future of AI in critical mineral exploration**
  - 📅 2025-12-02 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02879v1)

- **Think in Parallel, Answer as One: Logit Averaging for Open-Ended Reasoning**
  - 📅 2025-12-02 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02874v1)

- **Taming Camera-Controlled Video Generation with Verifiable Geometry Reward**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02870v1)

- **Assessing the performance of correlation-based multi-fidelity neural emulators**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02868v1)

- **MICCAI STSR 2025 Challenge: Semi-Supervised Teeth and Pulp Segmentation and CBCT-IOS Registration**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02867v1)

- **HeteroJIVE: Joint Subspace Estimation for Heterogeneous Multi-View Data**
  - 📅 2025-12-02 | 🏷️ `stat.ME, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.02866v1)
...
- **Phase-Adaptive LLM Framework with Multi-Stage Validation for Construction Robot Task Allocation: A Systematic Benchmark Against Traditional Optimization Algorithms**
  - 📅 2025-12-02 | 🏷️ `cs.RO, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02810v1)

- **SR-GRPO: Stable Rank as an Intrinsic Geometric Reward for Large Language Model Alignment**
  - 📅 2025-12-02 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02807v1)

- **TriLex: A Framework for Multilingual Sentiment Analysis in Low-Resource South African Languages**
  - 📅 2025-12-02 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02799v1)

- **Lost in Modality: Evaluating the Effectiveness of Text-Based Membership Inference Attacks on Large Multimodal Models**
  - 📅 2025-12-02 | 🏷️ `cs.CR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03121v1)

- **HUD: Hierarchical Uncertainty-Aware Disambiguation Network for Composed Video Retrieval**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.MM`
  - [Read Paper](https://arxiv.org/abs/2512.02792v2)

- **Making Dialogue Grounding Data Rich: A Three-Tier Data Synthesis Framework for Generalized Referring Expression Comprehension**
  - 📅 2025-12-02 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02791v1)

- **TrackNetV5: Residual-Driven Spatio-Temporal Refinement and Motion Direction Decoupling for Fast Object Tracking**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02789v1)

- **Diagnose, Correct, and Learn from Manipulation Failures via Visual Symbols**
  - 📅 2025-12-02 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02787v2)

- **FiMMIA: scaling semantic perturbation-based membership inference across modalities**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02786v1)
...
- **Perception of AI-Generated Music -- The Role of Composer Identity, Personality Traits, Music Preferences, and Perceived Humanness**
  - 📅 2025-12-02 | 🏷️ `cs.HC, cs.AI, cs.CY`
  - [Read Paper](https://arxiv.org/abs/2512.02785v1)

- **LumiX: Structured and Coherent Text-to-Intrinsic Generation**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.GR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02781v1)

- **Rethinking Surgical Smoke: A Smoke-Type-Aware Laparoscopic Video Desmoking Method and Dataset**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02780v1)
...
- **Input Order Shapes LLM Semantic Alignment in Multi-Document Summarization**
  - 📅 2025-12-02 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02665v1)
...
- **PolarGuide-GSDR: 3D Gaussian Splatting Driven by Polarization Priors and Deferred Reflection for Real-World Reflective Scenes**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02664v1)

- **Spatially-Grounded Document Retrieval via Patch-to-Region Relevance Propagation**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.IR`
  - [Read Paper](https://arxiv.org/abs/2512.02660v2)
...
- **Adaptive Weighted LSSVM for Multi-View Classification**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02653v1)

- **Pianist Transformer: Towards Expressive Piano Performance Rendering via Scalable Self-Supervised Pre-Training**
  - 📅 2025-12-02 | 🏷️ `cs.SD, cs.AI, cs.MM`
  - [Read Paper](https://arxiv.org/abs/2512.02652v1)

- **Real-Time Multimodal Data Collection Using Smartwatches and Its Visualization in Education**
  - 📅 2025-12-02 | 🏷️ `cs.HC, cs.CV, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.02651v1)

- **Hear What Matters! Text-conditioned Selective Video-to-Audio Generation**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.LG, cs.MM, cs.SD`
  - [Read Paper](https://arxiv.org/abs/2512.02650v1)

- **PoreTrack3D: A Benchmark for Dynamic 3D Gaussian Splatting in Pore-Scale Facial Trajectory Tracking**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02648v2)

- **Leveraging Large-Scale Pretrained Spatial-Spectral Priors for General Zero-Shot Pansharpening**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02643v1)

- **Joint Distillation for Fast Likelihood Evaluation and Sampling in Flow-based Models**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02636v1)

- **Zero-Shot Instruction Following in RL via Structured LTL Representations**
  - 📅 2025-12-02 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02633v1)
...
- **Real-Time Structural Health Monitoring with Bayesian Neural Networks: Distinguishing Aleatoric and Epistemic Uncertainty for Digital Twin Frameworks**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03115v1)
...
- **IACT: A Self-Organizing Recursive Model for General AI Agents: A Technical White Paper on the Architecture Behind kragent.ai**
  - 📅 2025-12-02 | 🏷️ `cs.AI, cs.MA, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.02605v1)

- **Spoken Conversational Agents with Large Language Models**
  - 📅 2025-12-02 | 🏷️ `cs.CL, cs.MA, cs.NE, cs.SD`
  - [Read Paper](https://arxiv.org/abs/2512.02593v1)

- **PaperDebugger: A Plugin-Based Multi-Agent System for In-Editor Academic Writing, Review, and Editing**
  - 📅 2025-12-02 | 🏷️ `cs.AI, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.02589v1)

- **GoRL: An Algorithm-Agnostic Framework for Online Reinforcement Learning with Generative Policies**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02581v1)

- **From Imitation to Discrimination: Toward A Generalized Curriculum Advantage Mechanism Enhancing Cross-Domain Reasoning Tasks**
  - 📅 2025-12-02 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02580v2)

- **Co-speech Gesture Video Generation via Motion-Based Graph Retrieval**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02576v1)

- **Can machines perform a qualitative data analysis? Reading the debate with Alan Turing**
  - 📅 2025-12-02 | 🏷️ `cs.CY, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.04121v1)

- **Feedback Loops and Code Perturbations in LLM-based Software Engineering: A Case Study on a C-to-Rust Translation System**
  - 📅 2025-12-02 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02567v1)

- **From Panel to Pixel: Zoom-In Vision-Language Pretraining from Biomedical Scientific Literature**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02566v1)
...
- **A Discrete Neural Operator with Adaptive Sampling for Surrogate Modeling of Parametric Transient Darcy Flows in Porous Media**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.03113v1)

- **EZYer: A simulacrum of high school with generative agent**
  - 📅 2025-12-02 | 🏷️ `cs.MA, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02561v1)

- **Empathy Level Prediction in Multi-Modal Scenario with Supervisory Documentation Assistance**
  - 📅 2025-12-02 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02558v1)

- **DeepSeek-V3.2: Pushing the Frontier of Open Large Language Models**
  - 📅 2025-12-02 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02556v1)

- **ADORE: Autonomous Domain-Oriented Relevance Engine for E-commerce**
  - 📅 2025-12-02 | 🏷️ `cs.CL, cs.AI, cs.IR`
  - [Read Paper](https://arxiv.org/abs/2512.02555v1)

- **OmniPerson: Unified Identity-Preserving Pedestrian Generation**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02554v1)
...
- **What Signals Really Matter for Misinformation Tasks? Evaluating Fake-News Detection and Virality Prediction under Real-World Constraints**
  - 📅 2025-12-02 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02552v1)

- **CUDA-L2: Surpassing cuBLAS Performance for Matrix Multiplication through Reinforcement Learning**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02551v2)

- **Sparse Computations in Deep Learning Inference**
  - 📅 2025-12-02 | 🏷️ `cs.CE, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02550v1)

- **Tensor Network Based Feature Learning Model**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02547v1)

- **In-Context Distillation with Self-Consistency Cascades: A Simple, Training-Free Way to Reduce LLM Agent Costs**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02543v1)

- **AVGGT: Rethinking Global Attention for Accelerating VGGT**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02541v1)

- **WeMMU: Enhanced Bridging of Vision-Language Models and Diffusion Models via Noisy Query Tokens**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02536v1)

- **Towards Contextual Sensitive Data Detection**
  - 📅 2025-12-02 | 🏷️ `cs.CR, cs.AI, cs.CL, cs.CY, cs.DB, cs.IR`
  - [Read Paper](https://arxiv.org/abs/2512.04120v1)

- **Laplace Approximation For Tensor Train Kernel Machines In System Identification**
  - 📅 2025-12-02 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02532v1)

- **Aetheria: A multimodal interpretable content safety framework based on multi-agent debate and collaboration**
  - 📅 2025-12-02 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02530v2)

- **A Concise Review of Hallucinations in LLMs and their Mitigation**
  - 📅 2025-12-02 | 🏷️ `cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02527v1)
...
- **TECM*: A Data-Driven Assessment to Reinforcement Learning Methods and Application to Heparin Treatment Strategy for Surgical Sepsis**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.10973v1)

- **Beyond Additivity: Sparse Isotonic Shapley Regression toward Nonlinear Explainability**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.AI, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.03112v1)

- **Generative Multi-modal Feedback for Singing Voice Synthesis Evaluation**
  - 📅 2025-12-02 | 🏷️ `cs.SD, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02523v1)

- **PanFoMa: A Lightweight Foundation Model and Benchmark for Pan-Cancer**
  - 📅 2025-12-02 | 🏷️ `cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.03111v1)

- **On the Problem of Consistent Anomalies in Zero-Shot Anomaly Detection**
  - 📅 2025-12-02 | 🏷️ `cs.CV, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.02520v1)

- **SkyMoE: A Vision-Language Foundation Model for Enhancing Geospatial Interpretation with Mixture of Experts**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02517v1)

- **Decentralized Fairness Aware Multi Task Federated Learning for VR Network**
  - 📅 2025-12-02 | 🏷️ `cs.LG, cs.IT`
  - [Read Paper](https://arxiv.org/abs/2512.02513v2)

- **Two-Stage Vision Transformer for Image Restoration: Colorization Pretraining + Residual Upsampling**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02512v2)

- **Water Quality Estimation Through Machine Learning Multivariate Analysis**
  - 📅 2025-12-02 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02508v1)

- **GeoDiT: A Diffusion-based Vision-Language Model for Geospatial Understanding**
  - 📅 2025-12-02 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02505v1)

- **AskNearby: An LLM-Based Application for Neighborhood Information Retrieval and Personalized Cognitive-Map Recommendations**
  - 📅 2025-12-02 | 🏷️ `cs.IR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02502v1)
...
- **The BEAT-CF Causal Model: A model for guiding the design of trials and observational analyses of cystic fibrosis exacerbations**
  - 📅 2025-12-02 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03110v1)
...
- **Enhancing Cross Domain SAR Oil Spill Segmentation via Morphological Region Perturbation and Synthetic Label-to-SAR Generation**
  - 📅 2025-12-02 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02290v1)

- **Model Recovery at the Edge under Resource Constraints for Physical AI**
  - 📅 2025-12-01 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02283v1)

- **DialogGuard: Multi-Agent Psychosocial Safety Evaluation of Sensitive LLM Responses**
  - 📅 2025-12-01 | 🏷️ `cs.AI, cs.HC, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.02282v1)

- **Bridging the Gap: Toward Cognitive Autonomy in Artificial Intelligence**
  - 📅 2025-12-01 | 🏷️ `cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02280v1)

- **Limitations of Membership Queries in Testable Learning**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.DS`
  - [Read Paper](https://arxiv.org/abs/2512.02279v1)

- **Adversarial Robustness of Traffic Classification under Resource Constraints: Input Structure Matters**
  - 📅 2025-12-01 | 🏷️ `cs.NI, cs.CR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02276v1)

- **Progressive Image Restoration via Text-Conditioned Video Generation**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02273v1)

- **Intrusion Detection on Resource-Constrained IoT Devices with Hardware-Aware ML and DL**
  - 📅 2025-12-01 | 🏷️ `cs.NI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02272v1)

- **Spatiotemporal Pyramid Flow Matching for Climate Emulation**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.AI, cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.02268v1)

- **The Effect of Enforcing Fairness on Reshaping Explanations in Machine Learning Models**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.CY`
  - [Read Paper](https://arxiv.org/abs/2512.02265v1)

- **Verifying Closed-Loop Contractivity of Learning-Based Controllers via Partitioning**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02262v1)

- **TradeTrap: Are LLM-based Trading Agents Truly Reliable and Faithful?**
  - 📅 2025-12-01 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02261v1)

- **EcoCast: A Spatio-Temporal Model for Continual Biodiversity and Climate Risk Forecasting**
  - 📅 2025-12-01 | 🏷️ `stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.02260v1)

- **Public Sentiment Analysis of Traffic Management Policies in Knoxville: A Social Media Driven Study**
  - 📅 2025-12-01 | 🏷️ `cs.SI, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03103v1)

- **Exploring the Potentials of Spiking Neural Networks for Image Deraining**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02258v2)

- **CAIRNS: Balancing Readability and Scientific Accuracy in Climate Adaptation Question Answering**
  - 📅 2025-12-01 | 🏷️ `cs.CL, cs.CY`
  - [Read Paper](https://arxiv.org/abs/2512.02251v1)

- **DETAIL Matters: Measuring the Impact of Prompt Specificity on Reasoning in Large Language Models**
  - 📅 2025-12-01 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02246v1)

- **PhishSnap: Image-Based Phishing Detection Using Perceptual Hashing**
  - 📅 2025-12-01 | 🏷️ `cs.CR, cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02243v1)

- **Dynamic Correction of Erroneous State Estimates via Diffusion Bayesian Exploration**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI, stat.CO`
  - [Read Paper](https://arxiv.org/abs/2512.03102v2)

- **Lightweight Latent Reasoning for Narrative Tasks**
  - 📅 2025-12-01 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02240v1)

- **Learning Robust Representations for Malicious Content Detection via Contrastive Sampling and Uncertainty Estimation**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08969v1)

- **See, Hear, and Understand: Benchmarking Audiovisual Human Speech Understanding in Multimodal Large Language Models**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02231v1)

- **Benchmarking LLM Agents for Wealth-Management Workflows**
  - 📅 2025-12-01 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02230v1)

- **STRIDE: A Systematic Framework for Selecting AI Modalities -- Agentic AI, AI Assistants, or LLM Calls**
  - 📅 2025-12-01 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02228v1)

- **Orchestration Framework for Financial Agents: From Algorithmic Trading to Agentic Trading**
  - 📅 2025-12-01 | 🏷️ `cs.MA, cs.AI, cs.CE, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02227v1)

- **Towards Unified Video Quality Assessment**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02224v1)

- **On the Approximation of Phylogenetic Distance Functions by Artificial Neural Networks**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02223v1)

- **StructuredDNA: A Bio-Physical Framework for Energy-Aware Transformer Routing**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.08968v1)

- **Uncertainty Reasoning with Photonic Bayesian Machines**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02217v1)

- **Improved Training Mechanism for Reinforcement Learning via Online Model Selection**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02214v1)

- **InstructLR: A Scalable Approach to Create Instruction Dataset for Under-Resourced Languages**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02213v1)

- **CluCERT: Certifying LLM Robustness via Clustering-Guided Denoising Smoothing**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.08967v1)

- **WhAM: Towards A Translative Model of Sperm Whale Vocalization**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.SD`
  - [Read Paper](https://arxiv.org/abs/2512.02206v1)

- **Swivuriso: The South African Next Voices Multilingual Speech Dataset**
  - 📅 2025-12-01 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02201v1)

- **Modelling the Doughnut of social and planetary boundaries with frugal machine learning**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02200v2)

- **Multifractal Recalibration of Neural Networks for Medical Imaging Segmentation**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02198v1)

- **Bin2Vec: Interpretable and Auditable Multi-View Binary Analysis for Code Plagiarism Detection**
  - 📅 2025-12-01 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02197v1)

- **A Knowledge-Based Language Model: Deducing Grammatical Knowledge in a Multi-Agent Language Acquisition Simulation**
  - 📅 2025-12-01 | 🏷️ `cs.CL, cs.AI, cs.LG, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.02195v1)

- **Enforcing Orderedness to Improve Feature Consistency**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02194v1)

- **From monoliths to modules: Decomposing transducers for efficient world modelling**
  - 📅 2025-12-01 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02193v1)

- **Story2MIDI: Emotionally Aligned Music Generation from Text**
  - 📅 2025-12-01 | 🏷️ `cs.SD, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02192v1)

- **RobustSurg: Tackling domain generalisation for out-of-distribution surgical scene segmentation**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02188v1)

- **Think Before You Prune: Self-Reflective Structured Pruning for Reasoning Language Models**
  - 📅 2025-12-01 | 🏷️ `cs.CL, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02185v1)

- **CLEF: Clinically-Guided Contrastive Learning for Electrocardiogram Foundation Models**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02180v1)

- **Young children's anthropomorphism of an AI chatbot: Brain activation and the role of parent co-presence**
  - 📅 2025-12-01 | 🏷️ `cs.HC, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02179v2)

- **Sampling on Metric Graphs**
  - 📅 2025-12-01 | 🏷️ `cs.DC, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02175v1)

- **SplatSuRe: Selective Super-Resolution for Multi-view Consistent 3D Gaussian Splatting**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.GR, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02172v1)

- **Flowchart2Mermaid: A Vision-Language Model Powered System for Converting Flowcharts into Editable Diagram Code**
  - 📅 2025-12-01 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02170v2)

- **Mapping of Lesion Images to Somatic Mutations**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02162v1)

- **FineGRAIN: Evaluating Failure Modes of Text-to-Image Models with Vision Language Model Judges**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02161v1)

- **Humanity in the Age of AI: Reassessing 2025's Existential-Risk Narratives**
  - 📅 2025-12-01 | 🏷️ `cs.CY, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.04119v1)

- **Factor(T,U): Factored Cognition Strengthens Monitoring of Untrusted AI**
  - 📅 2025-12-01 | 🏷️ `cs.CR, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02157v1)
...
- **Context-Enriched Contrastive Loss: Enhancing Presentation of Inherent Sample Connections in Contrastive Learning Framework**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02152v1)

- **CoatFusion: Controllable Material Coating in Images**
  - 📅 2025-12-01 | 🏷️ `cs.GR, cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02143v1)

- **Feature Selection Empowered BERT for Detection of Hate Speech with Vocabulary Augmentation**
  - 📅 2025-12-01 | 🏷️ `cs.CL, cs.AI, cs.NE`
  - [Read Paper](https://arxiv.org/abs/2512.02141v1)

- **Going All-In on LLM Accuracy: Fake Prediction Markets, Real Confidence Signals**
  - 📅 2025-12-01 | 🏷️ `cs.AI, cs.GT, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05998v1)

- **ALARM: Automated MLLM-Based Anomaly Detection in Complex-EnviRonment Monitoring with Uncertainty Quantification**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03101v1)

- **How Market Volatility Shapes Algorithmic Collusion: A Comparative Analysis of Learning-Based Pricing Algorithms**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.GT, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.02134v1)

- **Cross-View Topology-Aware Graph Representation Learning**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02130v1)

- **EfficientFlow: Efficient Equivariant Flow Policy Learning for Embodied AI**
  - 📅 2025-12-01 | 🏷️ `cs.RO, cs.AI, cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02020v2)

- **A Diffusion Model Framework for Maximum Entropy Reinforcement Learning**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.02019v2)

- **Data-Centric Visual Development for Self-Driving Labs**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.02018v1)

- **Visual Sync: Multi-Camera Synchronization via Cross-View Object Motion**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.AI, cs.LG, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.02017v1)
...
- **Objects in Generated Videos Are Slower Than They Appear: Models Suffer Sub-Earth Gravity and Don't Know Galileo's Principle...for now**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02016v1)

- **Generative Video Motion Editing with 3D Point Tracks**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02015v1)

- **Patient Safety Risks from AI Scribes: Signals from End-User Feedback**
  - 📅 2025-12-01 | 🏷️ `cs.CY, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04118v1)

- **TUNA: Taming Unified Visual Representations for Native Unified Multimodal Models**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02014v1)

- **Improved Mean Flows: On the Challenges of Fastforward Generative Models**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02012v1)

- **Four Over Six: More Accurate NVFP4 Quantization with Adaptive Block Scaling**
  - 📅 2025-12-01 | 🏷️ `cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02010v2)

- **AirSim360: A Panoramic Simulation Platform within Drone View**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02009v1)

- **The Art of Scaling Test-Time Compute for Large Language Models**
  - 📅 2025-12-01 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02008v1)

- **MV-TAP: Tracking Any Point in Multi-View Videos**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02006v1)

- **Learning Visual Affordance from Audio**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02005v1)

- **AlignSAE: Concept-Aligned Sparse Autoencoders**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.02004v1)

- **Learning Sim-to-Real Humanoid Locomotion in 15 Minutes**
  - 📅 2025-12-01 | 🏷️ `cs.RO, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01996v1)

- **Opening the Black Box: Nowcasting Singapore's GDP Growth and its Explainability**
  - 📅 2025-12-01 | 🏷️ `cs.LG, stat.AP`
  - [Read Paper](https://arxiv.org/abs/2512.02092v1)

- **RoaD: Rollouts as Demonstrations for Closed-Loop Supervised Fine-Tuning of Autonomous Driving Policies**
  - 📅 2025-12-01 | 🏷️ `cs.RO, cs.AI, cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01993v1)

- **LLM CHESS: Benchmarking Reasoning and Instruction-Following in LLMs through Chess**
  - 📅 2025-12-01 | 🏷️ `cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.01992v1)

- **PAI-Bench: A Comprehensive Benchmark For Physical AI**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01989v1)

- **Artemis: Structured Visual Reasoning for Perception Policy Learning**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01988v1)

- **Forecasting in Offline Reinforcement Learning for Non-stationary Environments**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.01987v2)
...
- **A robust generalizable device-agnostic deep learning model for sleep-wake determination from triaxial wrist accelerometry**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01986v1)

- **ECO: Energy-Constrained Operator Learning for Chaotic Dynamics with Boundedness Guarantees**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01984v1)

- **Feature-Based Semantics-Aware Scheduling for Energy-Harvesting Federated Learning**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.DC, cs.IT, cs.NI`
  - [Read Paper](https://arxiv.org/abs/2512.01983v1)

- **Low-Rank Prehab: Preparing Neural Networks for SVD Compression**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01980v1)

- **Chain-of-Ground: Improving GUI Grounding via Iterative Reasoning and Reference Feedback**
  - 📅 2025-12-01 | 🏷️ `cs.AI, cs.CL, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01979v1)

- **AI-Driven Optimization under Uncertainty for Mineral Processing Operations**
  - 📅 2025-12-01 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01977v1)

- **SGDiff: Scene Graph Guided Diffusion Model for Image Collaborative SegCaptioning**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01975v1)

- **From Atomic to Composite: Reinforcement Learning Enables Generalization in Complementary Reasoning**
  - 📅 2025-12-01 | 🏷️ `cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.01970v2)

- **SpriteHand: Real-Time Versatile Hand-Object Interaction with Autoregressive Video Generation**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.01960v1)

- **Ensemble Privacy Defense for Knowledge-Intensive LLMs against Membership Inference Attacks**
  - 📅 2025-12-01 | 🏷️ `cs.CR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.03100v1)

- **Learned-Rule-Augmented Large Language Model Evaluators**
  - 📅 2025-12-01 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01958v1)

- **KV Pareto: Systems-Level Optimization of KV Cache and Model Compression for Long Context Inference**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01953v1)
...
- **Script: Graph-Structured and Query-Conditioned Semantic Token Pruning for Multimodal Large Language Models**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01949v1)

- **How Far Are We from Genuinely Useful Deep Research Agents?**
  - 📅 2025-12-01 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.01948v2)

- **Guardian: Detecting Robotic Planning and Execution Errors with Vision-Language Models**
  - 📅 2025-12-01 | 🏷️ `cs.RO, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01946v2)

- **Agentic Policy Optimization via Instruction-Policy Co-Evolution**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.01945v1)

- **An Empirical Study of Agent Developer Practices in AI Agent Frameworks**
  - 📅 2025-12-01 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01939v1)

- **Physical ID-Transfer Attacks against Multi-Object Tracking via Adversarial Trajectory**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01934v1)

- **UnicEdit-10M: A Dataset and Benchmark Breaking the Scale-Quality Barrier via Unified Verification for Reasoning-Enriched Edits**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02790v1)
...
- **Automating modeling in mechanics: LLMs as designers of physics-constrained neural networks for constitutive modeling of materials**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01735v1)

- **Beyond Scaffold: A Unified Spatio-Temporal Gradient Tracking Method**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01732v1)

- **Reasoning About the Unsaid: Misinformation Detection with Omission-Aware Graph Inference**
  - 📅 2025-12-01 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.01728v1)

- **Beware of Reasoning Overconfidence: Pitfalls in the Reasoning Process for Multi-solution Tasks**
  - 📅 2025-12-01 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.01725v1)
...
- **RoleMotion: A Large-Scale Dataset towards Robust Scene-Specific Role-Playing Motion Synthesis with Fine-grained Descriptions**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01582v1)

- **From Black Hole to Galaxy: Neural Operator: Framework for Accretion and Feedback Dynamics**
  - 📅 2025-12-01 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01576v1)

- **Reconstructing Multi-Scale Physical Fields from Extremely Sparse Measurements with an Autoencoder-Diffusion Cascade**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01572v1)
...
- **Do Large Language Models Walk Their Talk? Measuring the Gap Between Implicit Associations, Self-Report, and Behavioral Altruism**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI, cs.CL, cs.CY`
  - [Read Paper](https://arxiv.org/abs/2512.01568v1)

- **Deep FlexQP: Accelerated Nonlinear Programming via Deep Unfolding**
  - 📅 2025-12-01 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01565v1)

- **MasHeNe: A Benchmark for Head and Neck CT Mass Segmentation using Window-Enhanced Mamba with Frequency-Domain Integration**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01563v2)
...
- **Intrinsic Structure as a Proxy for Saliency: SVD-Based Weight Preservation for Mixed-Precision Quantization in Large Language Models**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01343v2)

- **InternVideo-Next: Towards General Video Foundation Models without Video-Text Supervision**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01342v1)

- **EvalTalker: Learning to Evaluate Real-Portrait-Driven Multi-Subject Talking Humans**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01340v1)

- **EmoRAG: Evaluating RAG Robustness to Symbolic Perturbations**
  - 📅 2025-12-01 | 🏷️ `cs.CR, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.01335v1)

- **AlignVid: Training-Free Attention Scaling for Semantic Fidelity in Text-Guided Image-to-Video Generation**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01334v1)

- **Optimizing Stroke Risk Prediction: A Machine Learning Pipeline Combining ROS-Balanced Ensembles and XAI**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01333v1)

- **A Fast Heuristic Search Approach for Energy-Optimal Profile Routing for Electric Vehicles**
  - 📅 2025-12-01 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01331v1)

- **TagSplat: Topology-Aware Gaussian Splatting for Dynamic Mesh Modeling and Tracking**
  - 📅 2025-12-01 | 🏷️ `cs.GR, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01329v1)

- **Securing Large Language Models (LLMs) from Prompt Injection Attacks**
  - 📅 2025-12-01 | 🏷️ `cs.CR, cs.CL, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01326v1)

- **Panda: Self-distillation of Reusable Sensor-level Representations for High Energy Physics**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01324v1)

- **Extending NGU to Multi-Agent RL: A Preliminary Study**
  - 📅 2025-12-01 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01321v1)
...
- **Experimental Methods, Health Indicators, and Diagnostic Strategies for Retired Lithium-ion Batteries: A Comprehensive Review**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01294v1)

- **Diffusion Model in Latent Space for Medical Image Segmentation Task**
  - 📅 2025-12-01 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01292v2)
...
- **Supervised Contrastive Machine Unlearning of Background Bias in Sonar Image Classification with Fine-Grained Explainable AI**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01291v1)

- **OntoMetric: An Ontology-Guided Framework for Automated ESG Knowledge Graph Construction**
  - 📅 2025-12-01 | 🏷️ `cs.AI, cs.GR`
  - [Read Paper](https://arxiv.org/abs/2512.01289v1)

- **milearn: A Python Package for Multi-Instance Machine Learning**
  - 📅 2025-12-01 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01287v1)

- **Generative Modeling with Continuous Flows: Sample Complexity of Flow Matching**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01286v1)

- **AI-Enabled grading with near-domain data for scaling feedback with human-level accuracy**
  - 📅 2025-12-01 | 🏷️ `cs.CY, cs.AI, cs.HC, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.04113v1)

- **Kardia-R1: Unleashing LLMs to Reason toward Understanding and Empathy for Emotional Support via Rubric-as-Judge Reinforcement Learning**
  - 📅 2025-12-01 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01282v2)

- **Accelerating Large-Scale Reasoning Model Inference with Sparse Self-Speculative Decoding**
  - 📅 2025-12-01 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.01278v1)

- **Samplability makes learning easier**
  - 📅 2025-12-01 | 🏷️ `cs.CC, cs.DS, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01276v1)

- **SUPERChem: A Multimodal Reasoning Benchmark in Chemistry**
  - 📅 2025-12-01 | 🏷️ `cs.CL, cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01274v1)

- **nnMobileNet++: Towards Efficient Hybrid Networks for Retinal Image Analysis**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01273v1)

- **AI-Trader: Benchmarking Autonomous Agents in Real-Time Financial Markets**
  - 📅 2025-12-01 | 🏷️ `q-fin.CP, cs.CE`
  - [Read Paper](https://arxiv.org/abs/2512.10971v1)

- **ViscNet: Vision-Based In-line Viscometry for Fluid Mixing Process**
  - 📅 2025-12-01 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.01268v2)

- **Social Media Data Mining of Human Behaviour during Bushfire Evacuation**
  - 📅 2025-12-01 | 🏷️ `cs.SI, cs.AI, cs.ET, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.01262v1)

- **Efficient Hyperparameter Search for Non-Stationary Model Training**
  - 📅 2025-12-01 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.01258v1)
...
- **Provenance-Driven Reliable Semantic Medical Image Vector Reconstruction via Lightweight Blockchain-Verified Latent Fingerprints**
  - 📅 2025-11-30 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00999v1)

- **IndiMathBench: Autoformalizing Mathematical Reasoning Problems with a Human Touch**
  - 📅 2025-11-30 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00997v1)

- **S2AM3D: Scale-controllable Part Segmentation of 3D Point Cloud**
  - 📅 2025-11-30 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.00995v1)

- **PhotoFramer: Multi-modal Image Composition Instruction**
  - 📅 2025-11-30 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.00993v1)

- **Advancing Academic Chatbots: Evaluation of Non Traditional Outputs**
  - 📅 2025-11-30 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.00991v1)
...
- **Neural Discrete Representation Learning for Sparse-View CBCT Reconstruction: From Algorithm Design to Prospective Multicenter Clinical Evaluation**
  - 📅 2025-11-30 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.00873v1)

- **TAP-CT: 3D Task-Agnostic Pretraining of Computed Tomography Foundation Models**
  - 📅 2025-11-30 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00872v1)

- **HBLLM: Wavelet-Enhanced High-Fidelity 1-Bit Quantization for LLMs**
  - 📅 2025-11-30 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00862v3)
...
- **The Spectral Dimension of NTKs is Constant: A Theory of Implicit Regularization, Finite-Width Stability, and Scalable Estimation**
  - 📅 2025-11-30 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.00860v1)
...
- **Neuroscience-Inspired Memory Replay for Continual Learning: A Comparative Study of Predictive Coding and Backpropagation-Based Strategies**
  - 📅 2025-11-29 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00619v1)

- **ART: Adaptive Response Tuning Framework -- A Multi-Agent Tournament-Based Approach to LLM Response Optimization**
  - 📅 2025-11-29 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00617v1)

- **Stable Voting and the Splitting of Cycles**
  - 📅 2025-11-29 | 🏷️ `cs.GT, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00616v1)
...
- **Hierarchical Decentralized Multi-Agent Coordination with Privacy-Preserving Knowledge Sharing: Extending AgentNet for Scalable Autonomous Systems**
  - 📅 2025-11-29 | 🏷️ `cs.MA, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00614v1)

- **Generalized Graph Transformer Variational Autoencoder**
  - 📅 2025-11-29 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00612v1)

- **Prism: A Minimal Compositional Metalanguage for Specifying Agent Behavior**
  - 📅 2025-11-29 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.00611v1)

- **Statistical-computational gap in multiple Gaussian graph alignment**
  - 📅 2025-11-29 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.00610v1)

- **On the Holographic Geometry of Deterministic Computation**
  - 📅 2025-11-29 | 🏷️ `cs.CC, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00607v2)

- **Efficient Matroid Bandit Linear Optimization Leveraging Unimodality**
  - 📅 2025-11-29 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.00605v1)

- **AgentODRL: A Large Language Model-based Multi-agent System for ODRL Generation**
  - 📅 2025-11-29 | 🏷️ `cs.MA, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00602v1)

- **Large Language Model based Smart Contract Auditing with LLMBugScanner**
  - 📅 2025-11-29 | 🏷️ `cs.CR, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.02069v1)
...
- **Clinical-R1: Empowering Large Language Models for Faithful and Comprehensive Reasoning with Clinical Objective Relative Policy Optimization**
  - 📅 2025-11-29 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00601v2)

- **Developing Fairness-Aware Task Decomposition to Improve Equity in Post-Spinal Fusion Complication Prediction**
  - 📅 2025-11-29 | 🏷️ `cs.LG, cs.AI, cs.CY`
  - [Read Paper](https://arxiv.org/abs/2512.00598v1)
...
- **MM-DETR: An Efficient Multimodal Detection Transformer with Mamba-Driven Dual-Granularity Fusion and Frequency-Aware Modality Adapters**
  - 📅 2025-11-29 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.00363v1)

- **CourseTimeQA: A Lecture-Video Benchmark and a Latency-Constrained Cross-Modal Fusion Method for Timestamped QA**
  - 📅 2025-11-29 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.00360v1)
...
- **MILE: A Mechanically Isomorphic Exoskeleton Data Collection System with Fingertip Visuotactile Sensing for Dexterous Manipulation**
  - 📅 2025-11-29 | 🏷️ `cs.RO, cs.CV, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.00324v1)

- **Comparative Analysis of 47 Context-Based Question Answer Models Across 8 Diverse Datasets**
  - 📅 2025-11-29 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00323v1)

- **Superpixel Attack: Enhancing Black-box Adversarial Attack with Image-driven Division Areas**
  - 📅 2025-11-29 | 🏷️ `cs.CR, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.02062v1)

- **Introducing AI-Driven IoT Energy Management Framework**
  - 📅 2025-11-29 | 🏷️ `cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.00321v1)

- **Beyond Code Pairs: Dialogue-Based Data Generation for LLM Code Translation**
  - 📅 2025-11-29 | 🏷️ `cs.PL, cs.AI, cs.SE`
  - [Read Paper](https://arxiv.org/abs/2512.03086v1)

- **Fine-tuning an ECG Foundation Model to Predict Coronary CT Angiography Outcomes**
  - 📅 2025-11-29 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.05136v1)

- **RL-Struct: A Lightweight Reinforcement Learning Framework for Reliable Structured Output in LLMs**
  - 📅 2025-11-29 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.00319v2)

- **Tracing Mathematical Proficiency Through Problem-Solving Processes**
  - 📅 2025-11-29 | 🏷️ `cs.LG, cs.AI, cs.CY`
  - [Read Paper](https://arxiv.org/abs/2512.00311v1)

- **ART-ASyn: Anatomy-aware Realistic Texture-based Anomaly Synthesis Framework for Chest X-Rays**
  - 📅 2025-11-29 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.00310v1)

- **Optimizing Distributional Geometry Alignment with Optimal Transport for Generative Dataset Distillation**
  - 📅 2025-11-29 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.00308v1)

- **Adversarial Signed Graph Learning with Differential Privacy**
  - 📅 2025-11-29 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00307v2)

- **VCWorld: A Biological World Model for Virtual Cell Simulation**
  - 📅 2025-11-29 | 🏷️ `cs.AI, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.00306v1)

- **ChartPoint: Guiding MLLMs with Grounding Reflection for Chart Reasoning**
  - 📅 2025-11-29 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00305v1)

- **Gradient Inversion in Federated Reinforcement Learning**
  - 📅 2025-11-29 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00303v1)

- **TGSFormer: Scalable Temporal Gaussian Splatting for Embodied Semantic Scene Completion**
  - 📅 2025-11-29 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.00300v1)
...
- **Stochastic Dominance Constrained Optimization with S-shaped Utilities: Poor-Performance-Region Algorithm and Neural Network**
  - 📅 2025-11-29 | 🏷️ `q-fin.MF, cs.LG, q-fin.PM, q-fin.RM`
  - [Read Paper](https://arxiv.org/abs/2512.00299v1)
...
- **Challenges of Heterogeneity in Big Data: A Comparative Study of Classification in Large-Scale Structured and Unstructured Domains**
  - 📅 2025-11-29 | 🏷️ `cs.LG, cs.CL, cs.DC`
  - [Read Paper](https://arxiv.org/abs/2512.00298v1)

- **Words into World: A Task-Adaptive Agent for Language-Guided Spatial Retrieval in AR**
  - 📅 2025-11-29 | 🏷️ `cs.CV, cs.AI, cs.HC`
  - [Read Paper](https://arxiv.org/abs/2512.00294v1)

- **FiCoTS: Fine-to-Coarse LLM-Enhanced Hierarchical Cross-Modality Interaction for Time Series Forecasting**
  - 📅 2025-11-29 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00293v1)

- **EduEval: A Hierarchical Cognitive Benchmark for Evaluating Large Language Models in Chinese Education**
  - 📅 2025-11-29 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00290v1)

- **Data-Driven Modeling and Correction of Vehicle Dynamics**
  - 📅 2025-11-29 | 🏷️ `cs.LG, cs.RO`
  - [Read Paper](https://arxiv.org/abs/2512.00289v1)

- **RealAppliance: Let High-fidelity Appliance Assets Controllable and Workable as Aligned Real Manuals**
  - 📅 2025-11-29 | 🏷️ `cs.RO, cs.AI, cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.00287v1)

- **BioArc: Discovering Optimal Neural Architectures for Biological Foundation Models**
  - 📅 2025-11-29 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00283v2)

- **InvarDiff: Cross-Scale Invariance Caching for Accelerated Diffusion Models**
  - 📅 2025-11-29 | 🏷️ `cs.CV, cs.DC, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.05134v1)
...
- **UniDiff: Parameter-Efficient Adaptation of Diffusion Models for Land Cover Classification with Multi-Modal Remotely Sensed Imagery and Sparse Annotations**
  - 📅 2025-11-29 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.00261v1)
...
- **Scalable and Interpretable Scientific Discovery via Sparse Variational Gaussian Process Kolmogorov-Arnold Networks (SVGP KAN)**
  - 📅 2025-11-29 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.00260v1)

- **Relightable Holoported Characters: Capturing and Relighting Dynamic Human Performance from Sparse Views**
  - 📅 2025-11-29 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.00255v1)

- **DAISI: Data Assimilation with Inverse Sampling using Stochastic Interpolants**
  - 📅 2025-11-29 | 🏷️ `stat.ML, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.00252v1)

- **SD-CGAN: Conditional Sinkhorn Divergence GAN for DDoS Anomaly Detection in IoT Networks**
  - 📅 2025-11-28 | 🏷️ `cs.LG, cs.CR`
  - [Read Paper](https://arxiv.org/abs/2512.00251v1)

- **A Hierarchical Hybrid AI Approach: Integrating Deep Reinforcement Learning and Scripted Agents in Combat Simulations**
  - 📅 2025-11-28 | 🏷️ `cs.LG, cs.AI, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.00249v1)
...
- **Optimizing Information Asset Investment Strategies in the Exploratory Phase of the Oil and Gas Industry: A Reinforcement Learning Approach**
  - 📅 2025-11-28 | 🏷️ `cs.AI, cs.MA`
  - [Read Paper](https://arxiv.org/abs/2512.00243v1)

- **Polynomial Neural Sheaf Diffusion: A Spectral Filtering Approach on Cellular Sheaves**
  - 📅 2025-11-28 | 🏷️ `cs.LG, cs.AI, cs.ET, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.00242v1)

- **Self-Supervised Dynamical System Representations for Physiological Time-Series**
  - 📅 2025-11-28 | 🏷️ `cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.00239v1)

- **OmniFusion: Simultaneous Multilingual Multimodal Translations via Modular Fusion**
  - 📅 2025-11-28 | 🏷️ `cs.CL, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00234v1)
...
- **CodeFlowLM: Incremental Just-In-Time Defect Prediction with Pretrained Language Models and Exploratory Insights into Defect Localization**
  - 📅 2025-11-28 | 🏷️ `cs.SE, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00231v1)

- **Writing in Symbiosis: Mapping Human Creative Agency in the AI Era**
  - 📅 2025-11-28 | 🏷️ `cs.CY, cs.AI, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.13697v1)
...
- **TIE: A Training-Inversion-Exclusion Framework for Visually Interpretable and Uncertainty-Guided Out-of-Distribution Detection**
  - 📅 2025-11-28 | 🏷️ `cs.LG, cs.CV, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.00229v1)

- **DenseScan: Advancing 3D Scene Understanding with 2D Dense Annotation**
  - 📅 2025-11-28 | 🏷️ `cs.CV, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00226v1)

- **Statistical Inference under Adaptive Sampling with LinUCB**
  - 📅 2025-11-28 | 🏷️ `cs.LG, stat.ME, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.00222v1)

- **Minimal-Edit Instruction Tuning for Low-Resource Indic GEC**
  - 📅 2025-11-28 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.00219v1)

- **Reasoning Under Pressure: How do Training Incentives Influence Chain-of-Thought Monitorability?**
  - 📅 2025-11-28 | 🏷️ `cs.AI, cs.CR`
  - [Read Paper](https://arxiv.org/abs/2512.00218v2)

- **Towards Corpus-Grounded Agentic LLMs for Multilingual Grammatical Analysis**
  - 📅 2025-11-28 | 🏷️ `cs.CL`
  - [Read Paper](https://arxiv.org/abs/2512.00214v1)

- **On the Prediction of Wi-Fi Performance through Deep Learning**
  - 📅 2025-11-28 | 🏷️ `cs.NI, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00211v1)

- **ReactionMamba: Generating Short &Long Human Reaction Sequences**
  - 📅 2025-11-28 | 🏷️ `cs.CV`
  - [Read Paper](https://arxiv.org/abs/2512.00208v1)

- **Constructing Efficient Fact-Storing MLPs for Transformers**
  - 📅 2025-11-28 | 🏷️ `cs.LG, cs.AI`
  - [Read Paper](https://arxiv.org/abs/2512.00207v1)

- **From 'What-is' to 'What-if' in Human-Factor Analysis: A Post-Occupancy Evaluation Case**
  - 📅 2025-11-28 | 🏷️ `stat.AP, cs.LG`
  - [Read Paper](https://arxiv.org/abs/2512.02060v1)

- **Banach neural operator for Navier-Stokes equations**
  - 📅 2025-11-28 | 🏷️ `cs.NE, cs.LG, stat.ML`
  - [Read Paper](https://arxiv.org/abs/2512.09070v1)
...
- **BanglaSentNet: An Explainable Hybrid Deep Learning Framework for Multi-Aspect Sentiment Analysis with Cross-Domain Transfer Learning**
  - 📅 2025-11-28 | 🏷️ `cs.LG, cs.CL`
  - [Read Paper](https://arxiv.org/abs/2511.23264v1)

- **Adapting Like Humans: A Metacognitive Agent with Test-time Reasoning**
  - 📅 2025-11-28 | 🏷️ `cs.AI`
  - [Read Paper](https://arxiv.org/abs/2511.23262v1)

- **An Improved and Generalised Analysis for Spectral Clustering**
  - 📅 2025-11-28 | 🏷️ `cs.LG, cs.SI`
  - [Read Paper](https://arxiv.org/abs/2511.23261v1)
...
- **WorldLens: Full-Spectrum Evaluations of Driving World Models in Real World**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10958v1)

- **SceneMaker: Open-set 3D Scene Generation with Decoupled De-occlusion and Pose Estimation Model**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV, cs.AI`
  - [Access the article](https://arxiv.org/abs/2512.10957v1)

- **Empowering Dynamic Urban Navigation with Stereo and Mid-Level Vision**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10956v1)

- **Omni-Attribute: Open-vocabulary Attribute Encoder for Visual Concept Personalization**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10955v1)

- **Bidirectional Normalizing Flow: From Data to Noise and Back**
  - *Date:* 2025-12-11 | *Categories:* `cs.LG, cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10953v1)

- **Hierarchical Dataset Selection for High-Quality Data Sharing**
  - *Date:* 2025-12-11 | *Categories:* `cs.LG, cs.AI`
  - [Access the article](https://arxiv.org/abs/2512.10952v1)

- **Group Diffusion: Enhancing Image Generation by Unlocking Cross-Sample Collaboration**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10954v1)

- **E-RayZer: Self-supervised 3D Reconstruction as Spatial Visual Pre-training**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10950v1)

- **Are We Ready for RL in Text-to-3D Generation? A Progressive Investigation**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV, cs.AI, cs.CL`
  - [Access the article](https://arxiv.org/abs/2512.10949v1)

- **ClusIR: Towards Cluster-Guided All-in-One Image Restoration**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10948v1)

- **Towards Efficient and Effective Multi-Camera Encoding for End-to-End Driving**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10947v1)

- **ImplicitRDP: An End-to-End Visual-Force Diffusion Policy with Structural Slow-Fast Learning**
  - *Date:* 2025-12-11 | *Categories:* `cs.RO, cs.AI, cs.LG`
  - [Access the article](https://arxiv.org/abs/2512.10946v1)

- **MeViS: A Multi-Modal Dataset for Referring Motion Expression Video Segmentation**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10945v1)

- **AlcheMinT: Fine-grained Temporal Control for Multi-Reference Consistent Video Generation**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV, cs.AI`
  - [Access the article](https://arxiv.org/abs/2512.10943v1)

- **VL-JEPA: Joint Embedding Predictive Architecture for Vision-language**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10942v1)

- **Mull-Tokens: Modality-Agnostic Latent Thinking**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV, cs.AI`
  - [Access the article](https://arxiv.org/abs/2512.10941v1)

- **OmniView: An All-Seeing Diffusion Model for 3D and 4D View Synthesis**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV, cs.AI`
  - [Access the article](https://arxiv.org/abs/2512.10940v1)

- **GaussianHeadTalk: Wobble-Free 3D Talking Heads with Audio Driven Gaussian Splatting**
  - *Date:* 2025-12-11 | *Categories:* `cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10939v1)

- **Stronger Normalization-Free Transformers**
  - *Date:* 2025-12-11 | *Categories:* `cs.LG, cs.AI, cs.CL, cs.CV`
  - [Access the article](https://arxiv.org/abs/2512.10938v1)
